...
namespace OpMon {
    namespace Elements {
        ...
        SoundEvent::SoundEvent(sf::Texture &texture,
                               std::vector<sf::IntRect> rectangles,
                               EventTrigger eventTrigger,
                               sf::Vector2f const &position,
                               std::string const &playID, bool music,
                               bool toggle, int sides, bool passable)
        ...
        void SoundEvent::action(Overworld &overworld) {
            Ui::Jukebox &jukebox =
                overworld.getData().getGameDataPtr()->getJukebox();
