...
namespace OpMon {
    ...
    namespace Elements {
        ...
        enum class TurnActionType : unsigned int {
            ...
            ATK_UPDATE_HBAR =
                1,            /*!< Updates the health bar of player's OpMon.*/
            ATK_USE_ITEM = 2, /*!< The player's OpMon uses an item.*/
            ATK_STAT_MOD =
                3, /*!< The player's OpMon has a modification of stats.*/
            ...
            DEF_UPDATE_HBAR =
                7, /*!< Updates the health bar of the opponent's OpMon.*/
            DEF_USE_ITEM = 8, /*!< The opponent's OpMon uses an item.*/
            DEF_STAT_MOD =
                9, /*!< The opponent's OpMon has a modification of stats.*/
            DEF_OPMON_CBACK = 10, /*!< The opponent's OpMon quits the battle.*/
            DEF_OPMON_OUT =
                11,         /*!< The opponent's OpMon is sent to the battle.*/
