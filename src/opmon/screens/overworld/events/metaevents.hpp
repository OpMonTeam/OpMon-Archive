...
namespace OpMon {
     ...
     * \ingroup Events
     *
     * The TrainerEvent class is a basic meta event (Not a LinearMetaEvent)
     * containing three events : two TalkingCharaEvents and one BattleEvent. The
     * first TalkingCharaEvent represents the trainer before the battle, the
     * BattleEvent represents the battle and the second TalkingCharaEvent
     * represents the trainer after the battle.
     */
    class TrainerEvent : public AbstractMetaEvent {
      private:
         ...
         *
         * This variable is set to `false` at the end of the battle (if not
         * defeated) or dialog (if defeated).
         */
      ...
      public:
        TrainerEvent(TalkingCharaEvent *prebattlenpc, BattleEvent *battle,
