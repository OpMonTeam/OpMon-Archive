...
namespace OpMon {
    ...
    const NatureClass natures[25] = {
        BOLD,    BASHFUL, BRAVE,  CALM,  QUIET,   DOCILE, MILD,
        RASH,    GENTLE,  HARDY,  JOLLY, LAX,     IMPISH, SASSY,
        NAUGHTY, MODEST,  NAIVE,  HASTY, CAREFUL, QUIRKY, RELAXED,
        ADAMANT, SERIOUS, LONELY, TIMID};
