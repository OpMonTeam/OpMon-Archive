...
namespace OpMon::Model {
    ...
    class Species {
      ...
      public:
        ...
        [[nodiscard]] unsigned int getBaseAtk() const {
            return baseAtk;
        }
        [[nodiscard]] unsigned int getBaseDef() const {
            return baseDef;
        }
        [[nodiscard]] unsigned int getBaseAtkSpe() const {
            return baseAtkSpe;
        }
        [[nodiscard]] unsigned int getBaseDefSpe() const {
            return baseDefSpe;
        }
        [[nodiscard]] unsigned int getBaseSpe() const {
            return baseSpe;
        }
        [[nodiscard]] unsigned int getBaseHP() const {
            return baseHP;
        }
        ...
        [[nodiscard]] Evolution *getEvolType() const {
            return evolType;
        }
        [[nodiscard]] CurveExp *getCurve() const {
            return curve;
        }
        ...
        [[nodiscard]] std::vector<Stats> getEv() const {
            return EVgiven;
        }
        [[nodiscard]] int getOpdexNumber() const {
