...
namespace OpMon::Model {
    ...
    class OpMon {
      ...
      public:
        ...
        OpMon(const std::string &nickname, const Species *species, int level, std::vector<Attack *> attacks,
              Nature nature);
        ...
        void setStats(const int _stats[], Attack *_attacks[], const Species &_species, Type types[]);
        ...
        [[nodiscard]] int getStatHP() const {
            return statHP;
        }

        [[nodiscard]] int getStatLove() const {
            return statLove;
        }
        ...
        [[nodiscard]] int getStatEVA() const {
            return statEVA;
        }

        [[nodiscard]] float getStatACC() const {
            return statACC;
        }
        ...
        [[nodiscard]] int getStatATK() const {
            return statATK;
        }

        [[nodiscard]] int getStatATKSPE() const {
            return statATKSPE;
        }

        [[nodiscard]] int getStatDEF() const {
            return statDEF;
        }

        [[nodiscard]] int getStatDEFSPE() const {
            return statDEFSPE;
        }

        [[nodiscard]] int getStatSPE() const {
            return statSPE;
        }

        [[nodiscard]] const Species &getSpecies() const {
            return *species;
        }
