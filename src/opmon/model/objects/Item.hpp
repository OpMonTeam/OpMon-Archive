...
namespace OpMon::Model {
    ...
    class ItemEffect {
      public:
        ...
        virtual bool onOpMon(OpMon *opmon) { return false; }
        /** Effect when used on the field */
        virtual bool onField(Player *player) { return false; }
        /** Effect when held during a turn */
        virtual bool onHeld(Turn &owner, Turn &opponent) { return false; }
    ...
    namespace Items {
        ...
        class HpHealEffect : public ItemEffect {
          public:
            explicit HpHealEffect(int hpHealed);

            bool onOpMon(OpMon *opmon) override;
