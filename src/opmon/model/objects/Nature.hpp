  ...
  namespace Model{
    ...
    */
    ...
    public:
      ...
      int id;
      NatureClass(Stats bonus, Stats malus, int id) : bonus(bonus), malus(malus), id(id) {};
    ...
    */
    enum class Nature : unsigned int {
      BOLD, BASHFUL, BRAVE, CALM, QUIET, DOCILE, MILD, RASH, GENTLE, HARDY, JOLLY, LAX, IMPISH, SASSY, NAUGHTY, MODEST, NAIVE, HASTY, CAREFUL, QUIRKY, RELAXED, ADAMANT, SERIOUS, LONELY, TIMID
    };
  }
}
