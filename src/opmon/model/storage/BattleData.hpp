...
namespace OpMon::Model {
    ...
    class BattleData {
      ...
      public:
        ...
        sf::Texture &getBackground(const std::string &id) { return backgrounds[id]; }
        sf::Texture &getDialog() { return dialog; }
        sf::Texture &getAttackDialog() { return attackDialog; }
        sf::Texture &getCursor() { return cursor; }
        std::vector<sf::Texture> &getCharaBattleTextures(const std::string &id) { return charaBattleTextures[id]; }
