...
namespace OpMon {
    namespace Model {
        ...
        UiData::UiData(){
            ...
            listOp.emplace(34, new Species(72, 57, 55, 55, 65, 61, "Kameosan", Type::TOXIC, Type::NOTHING, 0, -1, new E_Item(34, Item::getItem("Pierre Lune")), std::vector<Stats>{Stats::ATK, Stats::ATK}, 0.9, 19.5, "Cette jarre de saké japonais a pris vie, elle peut aspirer du riz venant de l'exterieur, pour grossir encore son crâne.", 118, 1059860, 120, 34));
	        listOp.emplace(34, new Species(80, 35, 35, 45, 70, 40, "Poigno", Type::FIGHT, Type::NOTHING, 0, 28, new E_Level(35, 28), std::vector<Stats>{Stats::ATK}, 0.7, 18, "Il ne peut dissocier ses amis de ses ennemis et a tendance à  enrager lorsqu'on l'approche.", 74, 1000000, 190, 34));
