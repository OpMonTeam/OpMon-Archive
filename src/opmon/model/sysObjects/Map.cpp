...
Map::Map(const int layer1[], const int layer2[], const int layer3[], int w, int h, const char* const* collision, std::string bg, std::vector<std::string > const& animatedElements)
