...
namespace OpMon{
  ...
  namespace Initializer {
    ...
    void initOpMons() {
      ...
      Data::OpMons::listOp.try_emplace(5, 64, 58, 80, 65, 80, 58, "Rouxiflamme", Type::FEU, Type::NOTHING, 0, 36, new E_Level(6, 36), Model::Data::OpMons::evs[5], 1.1, 19, "Quand cette créature attaque, elle rougit de toute ses forces pour bruler son adversaire", 142, 1059860, 45, 5);
      Data::OpMons::listOp.try_emplace(6, 84, 78, 109, 85, 100, 78, "Enflammatorche", Type::FEU, Type::VOL, 0, -1, nullptr, Model::Data::OpMons::evs[6], 3.7, 90.5, "Le feu qui sort de son crâne peu très vite detruire tout sur son passage", 209, 1059860, 45, 6);
      Data::OpMons::listOp.try_emplace(7, 25, 35, 50, 54, 73, 44, "Nanolphin", Type::EAU, Type::NOTHING, 0, 16, new E_Level(8, 16), Model::Data::OpMons::evs[7], 0.5, 9, "Il adore nager en compagnie d'autres Nanolphins", 66, 1059860, 45, 7);
      Data::OpMons::listOp.try_emplace(8, 63, 80, 65, 80, 110, 59, "Deaulfin", Type::EAU, Type::NOTHING, 0, 36, new E_Level(9, 36), Model::Data::OpMons::evs[8], 1, 22.5,"Il peut cracher de l'eau grâce à sa queue, le jet est tellement puissant qu'il peut se déplacer sur terre", 143, 1059860, 45, 8);
      Data::OpMons::listOp.try_emplace(9, 120, 80, 75, 105, 30, 109, "Roileine", Type::EAU, Type::NOTHING, 0, -1,nullptr, Model::Data::OpMons::evs[9], 1.6, 85.5, "Il est le roi des océans de la région, il est capable de manger n'importe quoi, n'importe ou.", 210, 1059860, 45, 9);
