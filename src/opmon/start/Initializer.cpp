  ...
  namespace Initializer {
    ...
    void initOpMons() {
      ...
      Data::OpMons::listOp.try_emplace(0, 136, 0, 1, 1, 29, 33, "MissingNo.", Type::NORMAL, Type::VOL, 0, 80, new E_Level(0, 80), std::vector<Stats>{Stats::ATK}, 0, 0, "ERROR : MISSINGNO.", 0, 1250000, 3, 0);
       Data::OpMons::listOp.try_emplace(1, 49, 49, 65, 65, 45, 45, "Rosarin", Type::PLANTE, Type::NOTHING, 0, 16, new E_Level(2, 16), std::vector<Stats>{Stats::ATKSPE}, 0.7, 6.9, "L'amour de cet OpMon est incroyable, il ne demande que d'affection.", 64, 1059860, 45, 1);
      Data::OpMons::listOp.try_emplace(2, 62, 63, 80, 80, 60, 60, "Toxiris",Type::PLANTE, Type::POISON, 0, 32, new E_Level(3, 32), std::vector<Stats>{Stats::ATKSPE, Stats::ATKSPE}, 1, 13, "Cet OpMon est extrememnt puissant, il empoisonne de façon violente tout ce qui passe sur son chemin.", 141, 1059860, 45, 2);
      Data::OpMons::listOp.try_emplace(3, 82, 83, 100, 100, 80, 80, "Ninjasmine", Type::PLANTE, Type::POISON, 0, -1, nullptr, std::vector<Stats>{Stats::ATKSPE, Stats::ATKSPE, Stats::ATKSPE}, 2, 100, "Cet OpMon empoisonne ses adversaires rapidement grâce à ses 2 épées de poisons", 236, 1059860, 45, 3);
      Data::OpMons::listOp.try_emplace(4, 52, 43, 60, 50, 65, 39, "Titbraise", Type::FEU, Type::NOTHING, 0, 16, new E_Level(5, 16), std::vector<Stats>{Stats::ATK}, 0.2, 2.3, "C'est l'un des plus petit monstres de ce monde, il est assez inssignifiant mais il fait très mal quand il le veut", 65, 1059860, 45, 4);
      Data::OpMons::listOp.try_emplace(5, 64, 58, 80, 65, 80, 58, "Rouxiflamme", Type::FEU, Type::NOTHING, 0, 36, new E_Level(6, 36), std::vector<Stats>{Stats::ATK, Stats::ATK}, 1.1, 19, "Quand cette créature attaque, elle rougit de toute ses forces pour bruler son adversaire", 142, 1059860, 45, 5);
      Data::OpMons::listOp.try_emplace(6, 84, 78, 109, 85, 100, 78, "Enflammatorche", Type::FEU, Type::VOL, 0, -1, nullptr, std::vector<Stats>{Stats::ATK, Stats::ATK, Stats::ATKSPE}, 3.7, 90.5, "Le feu qui sort de son crâne peu très vite detruire tout sur son passage", 209, 1059860, 45, 6);
      Data::OpMons::listOp.try_emplace(7, 25, 35, 50, 54, 73, 44, "Nanolphin", Type::EAU, Type::NOTHING, 0, 16, new E_Level(8, 16), std::vector<Stats>{Stats::DEF}, 0.5, 9, "Il adore nager en compagnie d'autres Nanolphins", 66, 1059860, 45, 7);
      Data::OpMons::listOp.try_emplace(8, 63, 80, 65, 80, 110, 59, "Deaulfin", Type::EAU, Type::NOTHING, 0, 36, new E_Level(9, 36), std::vector<Stats>{Stats::DEF, Stats::DEFSPE}, 1, 22.5,"Il peut cracher de l'eau grâce à sa queue, le jet est tellement puissant qu'il peut se déplacer sur terre", 143, 1059860, 45, 8);
      Data::OpMons::listOp.try_emplace(9, 120, 80, 75, 105, 30, 109, "Roileine", Type::EAU, Type::NOTHING, 0, -1,nullptr, std::vector<Stats>{Stats::DEF, Stats::DEFSPE, Stats::DEFSPE}, 1.6, 85.5, "Il est le roi des océans de la région, il est capable de manger n'importe quoi, n'importe ou.", 210, 1059860, 45, 9);
      /*Data::OpMons::listOp.try_emplace(10, 30, 35, 20, 20, 45, 45, "Verpomme", Type::INSECTE, Type::ROCHE, 0, 7, new E_Level(11, 19), Model::Data::OpMons::evs[10], 0.3, 2.9, "Les Verpommes adorent aller dans les arbres pour faire semblant d'être des pommes, pour manger des sautinelles.", 53, 1000000, 255, 10);
      Data::OpMons::listOp.try_emplace(11, 20, 55, 25, 25, 30, 50, "Terrapatte", Type::INSECTE, Type::ROCHE, 0, 10, new E_Level(12, 25), Model::Data::OpMons::evs[11], 0.7, 9.9, "Les Terrapattes detestent qu'on ls prennent pour des Serpiterre", 72, 1000000, 120, 11);
      Data::OpMons::listOp.try_emplace(12, 105, 40, 70, 80, 75, 55, "Millepaterre", Type::ROCHE, Type::COMBAT, 0, -1, nullptr, Model::Data::OpMons::evs[12], 1.1, 32, "Cet OPMon contient plus d'un millier de petits pattes collantes, ce qui lui permet de se déplacer partout", 160, 1000000, 45, 12);
      Data::OpMons::listOp.try_emplace(13, 35, 30, 20, 20, 50, 40, "Sautinelle", Type::INSECTE, Type::NOTHING, 0, 7, new E_Level(14, 7),Model::Data::OpMons::evs[13], 0.3, 3.2, "Son aiguillon empoisonné est très dangereux. Son corps est coloré afin de repousser ses ennemis.", 52, 1000000, 255, 13);
      Data::OpMons::listOp.try_emplace(14, 25, 50, 25, 25, 35, 45, "Invavore", Type::INSECTE, Type::COMBAT, 0, 10, new E_Level(15, 10), Model::Data::OpMons::evs[14], 0.6, 10, "Incapable de se déplacer de lui-même, il se défend en durcissant sa carapace.", 71, 1000000, 120, 14);
      Data::OpMons::listOp.try_emplace(15, 80, 40, 45, 80, 75, 65, "Assautrèle", Type::INSECTE, Type::COMBAT, 0, -1, nullptr, Model::Data::OpMons::evs[15], 1, 29.5, "Il se sert de ses trois aiguillons empoisonnés pour attaquer sans relâche ses adversaires.", 159, 1000000, 45, 15);
      Data::OpMons::listOp.try_emplace(16, 45, 40, 35, 35, 56, 40, "Pelicamp", Type::NORMAL, Type::VOL, 0, 18, new E_Level(17, 18), Model::Data::OpMons::evs[16], 0.3, 1., "Cet OpMon adore voler seul, le problème, c'est qu'il n'est pas le seul dans le ciel...", 55, 1059860, 255, 16);
      Data::OpMons::listOp.try_emplace(17, 60, 55, 50, 50, 71, 63, "Grand-Bec", Type::NORMAL, Type::VOL, 0, 36, new E_Level(18, 36), Model::Data::OpMons::evs[17], 1.1, 30, "Il protège son territoire avec ardeur et repousse à  coup de bec tout intrus.", 113, 1059860, 120, 17);
      Data::OpMons::listOp.try_emplace(18, 80, 75, 50, 40, 190, 85, "Majelanion", Type::NORMAL, Type::VOL, 0, -1, nullptr, Model::Data::OpMons::evs[18], 1.5, 39.5, "Il adore attrapper des Ornitaupes en vol, sa vitesse et tellement forte que son corp siffle pednant son vol", 172, 1059860, 45, 18);
      Data::OpMons::listOp.try_emplace(19, 56, 35, 25, 35, 72, 30, "Ornitaupe", Type::NORMAL, Type::EAU, 0, 20, new E_Level(20, 27), Model::Data::OpMons::evs[19], 1.2, 7.5, "Cet OpMon creuse des tunnels à l'aide de sa queue plate, grâce à cela, son espece a developper dans cette queue une grande force.", 57, 1000000, 255, 19);
      Data::OpMons::listOp.try_emplace(20, 81, 60, 50, 70, 97, 55, "Ornitank", Type::NORMAL, Type::EAU, 0, -1, nullptr, Model::Data::OpMons::evs[20], 1.5, 38.5, "Il tire des balles grâce à son ventre, cela peut transpercer une montagne.", 127, 1000000, 127, 20);
      Data::OpMons::listOp.try_emplace(21, 60, 30, 31, 31, 70, 40, "Cridaile", Type::NORMAL, Type::VOL, 0, 20, new E_Level(22, 20), Model::Data::OpMons::evs[21], 0.4, 4, "Il chasse les Sautinelles dans les hautes herbes. Ses petites ailes lui permettent de voler très vite.", 58, 1000000, 255, 21);
      Data::OpMons::listOp.try_emplace(22, 160, 65, 31, 31, 10, 95, "Himondelle", Type::POISON, Type::VOL, 0, -1, nullptr, Model::Data::OpMons::evs[22], 1.9, 190, "Cet OPMon plutôt imposant, ne peut plus voler depuis qu'il a évoluer, cela resulte d'un manque de migrations du à l'abondance d'insectes dans cette région", 162, 1000000, 90, 22);
      Data::OpMons::listOp.try_emplace(23, 60, 44, 40, 54, 55, 35, "Serpiterre", Type::SOL, Type::TENEBRES, 0, 24, new E_Level(24, 22), Model::Data::OpMons::evs[23], 2, 6.9, "Plus il est âgé, plus son corps est long. Il se nourrit de spectres nocturnes caché sous terre", 62, 1000000, 255, 23);
      Data::OpMons::listOp.try_emplace(24, 85, 69, 65, 79, 80, 60, "Serpenair", Type::VOL, Type::TENEBRES, 0, -1, nullptr, Model::Data::OpMons::evs[24], 3.5, 65, "Il adore planer au dessus des ses proies, les fantomes de nuits, pour jouer avec eux, avant de les aspirer.", 147, 1000000, 90, 24);
      Data::OpMons::listOp.try_emplace(25, 55, 40, 50, 50, 90, 35, "Nucléage", Type::ELECTRIQUE, Type::NOTHING, 0, -1, new E_Item(26, Item::getItem("Invocation de la foudre")), Model::Data::OpMons::evs[25], 7.4, 6, "Ce nuage s'amuse à viser les monuments ou objets très grands, ils sont à l'origine des éclairs aleatoires dans le ciel. Ils aiment se caché parmi les vraies nuages", 82, 1000000, 100, 25);
      Data::OpMons::listOp.try_emplace(26, 200, 55, 90, 80, 110, 60, "Cielectrik", Type::ELECTRIQUE, Type::NOTHING, 0, -1, nullptr, Model::Data::OpMons::evs[26], 0., 30, "Il peut terrasser tout ses en libérant un décharge foudroyante plus de 550 000 V.", 122, 1000000, 65, 26);
      Data::OpMons::listOp.try_emplace(27, 60, 58, 30, 52, 33, 65, "Oursiflamme", Type::FEU, Type::NOTHING, 0, 28, new E_Level(19, 28),Model::Data::OpMons::evs[27], 0.5, 20, "Un si gentil ourson qui est tout feu tout flamme.", 93, 1000000, 45, 27);
      Data::OpMons::listOp.try_emplace(28, 80, 75, 60, 59, 54, 78, "Boudabrun", Type::FEU, Type::NOTHING, 0, 29, new E_Level(37,29), Model::Data::OpMons::evs[28], 1.9, 130.5, "Cet ours est colérique, un rien peut lui mettre le feu au poudre.", 122, 1000000, 60, 28);
      Data::OpMons::listOp.try_emplace(29, 110, 96, 92, 74, 72, 84, "Calcinours", Type::FEU, Type::COMBAT, 0, -1, nullptr, Model::Data::OpMons::evs[29], 2.6, 588, "Cet ours serait capable de mettre à feu et à sang n'importe quoi.", 172, 1250000, 172, 29);
      Data::OpMons::listOp.try_emplace(30, 62, 67, 55, 55, 26, 90, "Calame", Type::POISON, Type::EAU, 0, -1, new E_Item(31, Item::getItem("Pierre Eau")), Model::Data::OpMons::evs[30], 0.9, 20, "Ce mignon petit OpMon asire les âmes de ses ennemis et les recrache pour les attaquer", 117, 1059860, 120, 30);
      Data::OpMons::listOp.try_emplace(31, 92, 87, 75, 85, 76, 90, "Bolderi", Type::POISON, Type::SOL, 0, -1, new E_Nope(), Model::Data::OpMons::evs[31], 1.3, 60, "Il controle le riz, il est capable de faire le faire voler, et même de faire des formes avec.", 194, 1059860, 45, 31);
      Data::OpMons::listOp.try_emplace(32, 57, 40, 40, 40, 50, 46, "Dragonbolderi‚", Type::POISON, Type::NOTHING, 0, 16, new E_Level(33, 16), Model::Data::OpMons::evs[32], 0.5, 9, "Ce dragon en riz est capable d'éviter les coups en creant des trous dans son corps, mais à part cela, il peut à peine voler.", 60, 1059860, 235, 32);
      Data::OpMons::listOp.try_emplace(33, 72, 57, 55, 55, 65, 61, "Kameosan", Type::POISON, Type::NOTHING, 0, -1,new E_Item(34, Item::getItem("Pierre Lune")), Model::Data::OpMons::evs[33], 0.9, 19.5, "Cette jarre de saké japonais a pris vie, elle peut aspirer du riz venant de l'exterieur, pour grossir encore son crâne.", 118, 1059860, 120, 33);
      /*Data::OpMons::listOp.try_emplace(34, 102, 77, 85, 75, 85, 81, "Nidoking", Type::POISON, Type::SOL, 0, -1, new E_Nope(), Model::Data::OpMons::evs[34], 1.4, 62, "Un coup de sa puissante queue peut briser un poteau téléphonique comme une allumette.", 195, 1059860, 45, 34);
	Data::OpMons::listOp.try_emplace(35, 45, 48, 60, 65, 35, 70, "Mélofée", Type::FEE, Type::NOTHING, 0, -1, new E_Item(36, Item::getItem("Pierre Lune")), Model::Data::OpMons::evs[35], 06, 7.5, "La lumière de la lune qu'il emmagasine dans ses ailes dorsales lui permet de flotter dans les airs.", 68, 800000, 150, 35);
	Data::OpMons::listOp.try_emplace(36, 70, 73, 95, 90, 60, 95, "Mélodelfe", Type::FEE, Type::NOTHING, 0, -1, new E_Nope(), Model::Data::OpMons::evs[36], 1.3, 40, "Il aime le calme des montagnes. Son ouà¯e exceptionnelle entendrait une aiguille tomber à  1km.", 129, 8000000, 25, 36);
	Data::OpMons::listOp.try_emplace(37, 41, 40, 50, 65, 65, 38, "Goupix", Type::FEU, Type::NOTHING, 0, -1, new E_Item(38, Item::getItem("Pierre Feu")), Model::Data::OpMons::evs[37], 0.6, 9.9, "Avec l'âge, la fourrure de ses six queues devient de plus en plus belle et soyeuse. Elle est chaude au toucher.",63, 1000000, 190, 37);//TROP KAWAII!!!!
	Data::OpMons::listOp.try_emplace(38, 76, 75, 81, 100, 100, 73, "Feunard", Type::FEU, Type::NOTHING, 0, -1, new E_Nope(), Model::Data::OpMons::evs[38], 1.1, 19.9, "Il a neuf longues queues et une fourrure qui brille comme de l'or. On dit qu'il peut vivre 1 000 ans.", 178, 1000000, 75, 38);
	Data::OpMons::listOp.try_emplace(39, 45, 20, 45, 25, 20, 115, "Rondoudou", Type::NORMAL, Type::FEE, 0, -1, new E_Item(40, Item::getItem("Pierre Lune")), {Model::Data::OpMons::evs[39], 0.5, 5.5, "En se gonflant, il peut chanter une longue berceuse qui endort inévitablement ses adversaires.", 76, 800000, 170, 39);
	Data::OpMons::listOp.try_emplace(40, 70, 45, 85, 50, 45, 140, "Grodoudou", Type::NORMAL, Type::FEE, 0, -1, new E_Nope(), Model::Data::OpMons::evs[40], 1, 12, "En cas de danger, il gonfle d'air son corps doux et potelé dans des proportions gigantesques.", 109, 800000, 50, 40);
	Data::OpMons::listOp.try_emplace(41, 45, 35, 30, 40, 55, 40, "Nosferapti", Type::POISON, Type::VOL, 0, 22, new E_Level(42, 22), Model::Data::OpMons::evs[41], 0., 7.5, "Ce pokemon est détesté en raison de sa forte présence dans les grottes. Malgré le fait qu'il n'aie pas d'yeux, ce pokemon arrive a voir avec des utltrasons.", 54, 1000000, 255, 41);
	Data::OpMons::listOp.try_emplace(42, 80, 70, 65, 75, 90, 75, "Nosferalto", Type::POISON, Type::VOL, 0, -1, new E_Love(0), Model::Data::OpMons::evs[42], 1.6, 55, "Quand il se met à  sucer du sang, il ne s'arrÃªte qu'une fois rassasié. C'est un chasseur nocturne.", 171, 1000000, 90, 42);
	Data::OpMons::listOp.try_emplace(43, 50, 55, 75, 65, 30, 45, "Mystherbe", Type::PLANTE, Type::POISON, 0, 21, new E_Level(44, 21), Model::Data::OpMons::evs[43], 0.5, 5.4, "Le jour, il reste en sous-sol et évite le soleil. Il grandit en se baignant au clair de lune.", 78, 1059860, 255, 43);
	Data::OpMons::listOp.try_emplace(44, 65, 70, 85, 75, 40, 60, "Ortide", Type::PLANTE, Type::POISON, 0, -1, new E_Item(45, Item::getItem("Pierre Plante")) , Model::Data::OpMons::evs[44], 0., 8.6, "Il sent très mauvais ! Mais une personne sur 1 000 aime la puanteur de son corps nauséabond.", 132, 1059860, 120, 44);
	Data::OpMons::listOp.try_emplace(45, 80, 85, 110, 90, 50, 75, "Rafflesia", Type::PLANTE, Type::POISON, 0, -1, new E_Nope(), Model::Data::OpMons::evs[45], 1.2, 18.6, "Il possède des pétales énormes. à chaque pas, ils sèment d'épais nuages de pollen toxique.", 184, 1059860, 45, 45);
	Data::OpMons::listOp.try_emplace(46, 70, 55, 45, 55, 25, 35, "Paras", Type::INSECTE, Type::PLANTE, 0, 24, new E_Level(47, 24), Model::Data::OpMons::evs[46], 0.3, 5.4, "Il s'enfouit sous terre pour ronger des racines afin de nourrir les champignons sur son dos.", 70, 1000000, 190, 46);
	Data::OpMons::listOp.try_emplace(47, 95, 80, 60, 80, 30, 60, "Parasect", Type::INSECTE, Type::PLANTE, 0, -1, new E_Nope(), Model::Data::OpMons::evs[47], 1, 29.5, "Un champignon parasite plus gros que Parasect contrôle son corps. Il répand des spores empoisonnées.", 128, 1000000, 75, 47);
	Data::OpMons::listOp.try_emplace(48, 55, 50, 40, 55, 45, 60, "Mimitoss", Type::INSECTE, Type::POISON, 0, 31, new E_Level(49, 31), Model::Data::OpMons::evs[48], 1, 30, "Il vit à  l'ombre des grands arbres où il se nourrit d'insectes. Il est attiré par la lumière.", 75, 1000000, 190, 48);
...
_______________________________________________
	...
	Data::OpMons::listOp.try_emplace(56, 80, 35, 35, 45, 70, 40, "Férosinge", Type::COMBAT, Type::NOTHING, 0, 28, new E_Level(57, 28),Model::Data::OpMons::evs[56], 0.5, 2, "Il ne peut dissocier ses amis de ses ennemis et a tendance à  enrager lorsqu'on l'approche.", 74, 1000000, 190, 56);
	Data::OpMons::listOp.try_emplace(57, 105, 60, 60, 70, 95, 65, "Colossinge", Type::COMBAT, Type::NOTHING, 0, -1, new E_Nope(), Model::Data::OpMons::evs[57], 1, 32, "Sa fureur prend fin quand il n'a plus personne à  frapper. Il est difficile d'en Ãªtre témoin.", 149, 1000000, 75, 57);
	Data::OpMons::listOp.try_emplace(58, 70, 45, 70, 50, 60, 55, "Caninos", Type::FEU, Type::NOTHING, 0, -1, new E_Item(59, Item::getItem("Pierre Feu")),Model::Data::OpMons::evs[58], 0.7, 19, "Il est courageux et fier. Il se dresse vaillamment devant ses ennemis mÃªme s'ils sont plus _puissants.", 91, 1250000, 190, 58);
	Data::OpMons::listOp.try_emplace(59, 110, 80, 100, 80 , 95, 90, "Arcanin", Type::FEU, Type::NOTHING, 0, -1, new E_Nope(),Model::Data::OpMons::evs[59], 1.9, 155, "Son aboiement est tout simplement majestueux. On ne peut que ramper à  ses pieds après l'avoir entendu.", 213, 1250000, 75, 59);
	Data::OpMons::listOp.try_emplace(60, 50, 40, 40, 40, 90, 40, "Ptitard", Type::EAU, Type::NOTHING, 0, 25, new E_Level(61, 25), Model::Data::OpMons::evs[60], 0.6, 12.4, "Sa peau est si mince qu'on voit ses organes internes. Il tient à  peine sur ses nouveaux pieds.", 77, 1059860, 255, 60);
	Data::OpMons::listOp.try_emplace(61, 65, 65, 50, 50, 90, 65, "TÃªtarte", Type::EAU, Type::NOTHING, 0, -1, new E_Item(62, Item::getItem("Pierre Eau")), Model::Data::OpMons::evs[61], 1, 20, " Ce Pokémon amphibie transpire continuellement quand il est hors de l'eau afin d'hydrater son corps.", 131, 1059860, 120, 61);
	Data::OpMons::listOp.try_emplace(62, 95, 95, 70, 90, 70, 90, "Tartard", Type::EAU, Type::COMBAT, 0, -1, new E_Nope(), Model::Data::OpMons::evs[62], 1.3, 54, "Il possède de sacrés biscoteaux. Il peut parcourir sans relâche l'Océan Pacifique.", 185, 1059860, 45, 62);
	Data::OpMons::listOp.try_emplace(63, 20, 15, 105, 55, 90, 25, "Abra", Type::PSY, Type::NOTHING, 0, 16, new E_Level(64, 16), Model::Data::OpMons::evs[63], 0.9, 19.5, "Il prévoit les attaques futures et se téléporte pour se mettre à  l'abri et éviter le combat.", 75, 1059860, 200, 63);
	Data::OpMons::listOp.try_emplace(64, 35, 30, 120, 70, 105, 40, "Kadabra", Type::PSY, Type::NOTHING, 0, -1, new E_Trade(65), Model::Data::OpMons::evs[64], 1.3, 56.5, "En utilisant ses pouvoirs, il émet des ondes alphas et cause des distorsions électroniques.", 145, 1059860, 100, 64);
	Data::OpMons::listOp.try_emplace(65, 50, 45, 135, 95, 120, 55, "Alakazam", Type::PSY, Type::NOTHING, 0, -1, new E_Nope(), Model::Data::OpMons::evs[65], 1.5, 4, "Son cerveau hors du commun peut effectuer des opérations à  la vitesse d'un ordinateur. Il a un QI de 5 000.", 186, 1059860, 50, 65);
	Data::OpMons::listOp.try_emplace(66, 80, 50, 35, 35, 35, 70, "Machoc", Type::COMBAT, Type::NOTHING, 0, 28, new E_Level(67, 28), Model::Data::OpMons::evs[66], 0., 19.5, "Son corps est essentiellement composé de muscles. MÃªme s'il a la taille d'un petit enfant, il peut soulever 100 adultes avec ses bras.", 75, 1059860, 180, 66);
	Data::OpMons::listOp.try_emplace(67, 100, 70, 50, 60, 45, 80, "Machopeur", Type::COMBAT, Type::NOTHING, 0, -1, new E_Trade(68), Model::Data::OpMons::evs[67], 1.5, 70.5, "Son corps est si puissant qu'il lui faut une ceinture de force pour équilibrer ses mouvements.", 146, 1059860, 90, 67);
	Data::OpMons::listOp.try_emplace(68, 130, 80, 65, 85, 55, 90, "Mackogneur", Type::COMBAT, Type::NOTHING, 0, -1, new E_Nope(),Model::Data::OpMons::evs[68], 1.6, 130, "Ses deux paires de bras permettent à  Mackogneur d'envoyer une série de 1000 coups de poing en 2s.", 193, 1059860, 45, 68);
...
___________________________________
 /*Data::OpMons::listOp.try_emplace(74, 80, 100, 30, 30, 20, 40, "Racaillou", Type::ROCHE, Type::SOL, 0, 25, new E_Level(75, 25),Model::Data::OpMons::evs[74], 0.4, 20, "Il vit dans les plaines ou les montagnes. On le confond souvent avec un petit caillou.", 73, 1059860, 255, 74);
	...
	Data::OpMons::listOp.try_emplace(78, 100, 70, 80, 80, 105, 65, "Galopa", Type::FEU, Type::NOTHING, 0, -1, new E_Nope(), Model::Data::OpMons::evs[78], 1.7, 95, "Au grand galop, sa crinière de feu disperse au vent une myriade d'étincelles ardentes.", 192, 1000000, 60, 78);
	Data::OpMons::listOp.try_emplace(79, 65, 65, 40, 40, 15, 90, "Ramoloss", Type::EAU, Type::PSY, 0, 37, new E_Level(80, 37), Model::Data::OpMons::evs[79], 1.2, 36, "Il est tellement paresseux qu'il lui faut une journée pour remarquer qu'on lui mord la queue.", 99, 1000000, 190, 79);
	Data::OpMons::listOp.try_emplace(80, 75, 110, 100, 80, 30, 95, "Flagadoss", Type::EAU, Type::PSY, 0, -1, new E_Nope(), Model::Data::OpMons::evs[80], 1.6, 78.5, "Le Kokiyas accroché à  sa queue est friand de ce qu'il dévore et ne veut pas lâcher prise.", 164, 1000000, 75, 80);
	Data::OpMons::listOp.try_emplace(81, 35, 70, 95, 55, 45, 25, "Magneti", Type::ELECTRIQUE, Type::ACIER, 0, 30, new E_Level(81, 30), Model::Data::OpMons::evs[81],0.3, 6, "Les parties sur les côtés de son corps génèrent une énergie lui permettant de léviter.", 89, 1000000, 190, 81);
	Data::OpMons::listOp.try_emplace(82, 60, 95, 120, 70, 70, 50, "Magnéton", Type::ELECTRIQUE, Type::ACIER, 0, -1, new E_Land(0, "Grotte Electrac"), Model::Data::OpMons::evs[82], 1, 60, "Des groupes apparaissent si des taches solaires couvrent le soleil. Il brouillent les télévisions.", 161, 1000000, 60, 82);
	Data::OpMons::listOp.try_emplace(83, 65, 55, 58, 62, 52, 52, "Canarticho", Type::NORMAL, Type::VOL, 0, -1, new E_Nope(), Model::Data::OpMons::evs[83], 0., 15, "Il utilise le légume qu'il tient comme s'il s'agissait d'une épée.", 94, 1000000, 45, 83);
	Data::OpMons::listOp.try_emplace(84, 85, 45, 35, 35, 75, 35, "Doduo", Type::NORMAL, Type::VOL, 0, 31, new E_Level(31, 85), Model::Data::OpMons::evs[84], 1.4, 39.2, "Ses deux cerveaux semblent communiquer leurs émotions grâce à  un lien télépathique.", 96, 1000000, 190, 84);
...
_______________________________
	...
	Data::OpMons::listOp.try_emplace(100, 76, 54, 89, 48, 60, 150, "MagMortis", Type::FEU, Type::ROCHE, 0, -1,nullptr, Model::Data::OpMons::evs[100], 3.64, 532, "Cet Opmon oublié au fil du temps est à l'origine de la disparition d'une ancienne génération de monstres combattants.", 200, 1850000, 4, 100);
