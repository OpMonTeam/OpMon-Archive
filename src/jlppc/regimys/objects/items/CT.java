...
public class CT <T> extends Item {
	 ...
	 * @param ctnumber - Le num�ro de CT
	 */
	 ...
	 * 
	 * @param atk - La classe de l'attaque
	 * @param isCS - Le boolean indiquant si c'est une cs (un peu inutile, puisque ce constructeur n'est destin� qu'aux CS. Il peut neemoins servir pour les CT)
	 * @param csnumber - Le num�ro de la CS
	 */
