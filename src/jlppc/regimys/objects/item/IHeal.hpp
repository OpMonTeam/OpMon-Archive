...
class I_Heal: public Item {
    public:
        ...
        I_Heal(std::string &nom, bool usable, bool usableInFight, bool givable, int categorie, int hpHeal, int heal, bool healAllStatus, int ID);
        ...
        I_Heal(std::string &nom, bool usable, bool usableInFight, bool givable, int categorie, int hpHeal, int ID);
