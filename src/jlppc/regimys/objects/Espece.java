...
/**
 * La classe qui d�finit une esp�ce de Pok�mon.
 * 
 * @author Jlppc
 *
 */
public class Espece implements Serializable{
	...
	/**Liste des CT combatibles avec le Pok�mon*/
	...
	/**
	 * La coubre d'experience du pok�mon
	 */
	protected CourbeExp courbe;
	/**
	 * L'exp du pok�mon au niveau 100
	 */
	...
	/**
	 * Permet d'enregistrer l'�volution. Doit �tre lanc� apr�s la d�claration de tous les pok�mon.
	 */
