...
namespace Initializer {
	...
	void initPokemons() {
		...
		using namespace Evolutions;
		 listePoke[0] = new Espece(136, 0, 1, 1, 29, 33, "Minsingno", Type::NORMAL, Type::VOL, 0, 80, new E_Level(0, 80), evs[0], 0, 0, "ERROR : MISSINGNO.", 0, 1250000, 3, 0);
		 listePoke[1] = new Espece(49, 49, 65, 65, 45, 45, "Rosarin", Type::PLANTE, Type::POISON, 0, 16, new E_Level(2, 16), evs[1], 0.7, 6.9, "L'amour de cet OpenMonster est incroyable, il ne demande que d'affection.", 64, 1059860, 45, 1);
		 listePoke[2] = new Espece(62, 63, 80, 80, 60, 60, "Poisiplante",Type::PLANTE, Type::POISON, 0, 32, new E_Level(3, 32), evs[2], 1, 13, "Cet OpenMonster est extrememnt puissant, il empoisonne de façon violente tout ce qui passe sur son chemin.", 141, 1059860, 45, 2);
		 listePoke[3] = new Espece(82, 83, 100, 100, 80, 80, "Toxiris", Type::PLANTE, Type::POISON, 0, -1, ne, evs[3], 2, 100, "Cet OpenMonster a la capacité de laché son poison a une vitesse exeptionnelle", 236, 1059860, 45, 3);
		 listePoke[4] = new Espece(52, 43, 60, 50, 65, 39, "Titbraise", Type::FEU, Type::AUCUN, 0, 16, new E_Level(5, 16), evs[4] , 0.6, 8.5, "C'est l'un des plus petit monstres de ce monde, il est assez inssignifiant mais il fait très mal quand il le veux", 65, 1059860, 45, 4);
		 listePoke[5] = new Espece(64, 58, 80, 65, 80, 58, "Rouxiflamme", Type::FEU, Type::AUCUN, 0, 36, new E_Level(6, 36), evs[5], 1.1, 19, "En agitant sa gueue, il peut élever la température à  un niveau incroyable", 142, 1059860, 45, 5);
		 listePoke[6] = new Espece(84, 78, 109, 85, 100, 78, "Enflammator", Type::FEU, Type::VOL, 0, -1, ne, evs[6], 1.7, 90.5, "Quand il crache son souffle brulant, la flamme au bout de sa queue s'embrase.", 209, 1059860, 45, 6);
		 listePoke[7] = new Espece(48, 65, 50, 64, 43, 44, "Picolphin", Type::EAU, Type::AUCUN, 0, 16, new E_Level(8, 16), evs[7], 0.5, 9, "Caché sous l'eau, il crache un jet d'eau sur sa proie et se cache à  l'intérieur de sa carapace.", 66, 1059860, 45, 7);
		 listePoke[8] = new Espece(63, 80, 65, 80, 58, 59, "Deaulfin", Type::EAU, Type::AUCUN, 0, 36, new E_Level(9, 36), evs[8], 1, 22.5,"On prétend qu'il vit 10 000 ans. Sa queue duveteuse est un symbole de longévité populaire.", 143, 1059860, 45, 8);
		 listePoke[9] = new Espece(83, 100, 85, 105, 78, 79, "Roileine", Type::EAU, Type::AUCUN, 0, -1,ne, evs[9], 1.6, 85.5, "Il écrase ses adversaires de tout son poids pour leur faire perdre connaissance. Il rentre dans sa carapace s'il se sent en danger.", 210, 1059860, 45, 9);
		 ...
		 listePoke[11] = new Espece(20, 55, 25, 25, 30, 50, "Chrysacier", Type::INSECTE, Type::AUCUN, 0, 10, new E_Level(12, 10), evs[11], 0.7, 9.9, "Son corps frÃªle est protégé par sa carapace d'acier. Il encaisse les coups durs en attendant d'évoluer.", 72, 1000000, 120, 11);
		 listePoke[12] = new Espece(45, 50, 90, 80, 70, 60, "Papilusion", Type::INSECTE, Type::VOL, 0, -1, ne, {Stats.ATKSPE,evs[12],1.1, 32, "Ses ailes sont recouvertes d'une poudre les protégeant de la pluie. Ce Pokémon peut donc voler pendant de grosses averses.", 160, 1000000, 45, 12);
		 listePoke[13] = new Espece(35, 30, 20, 20, 50, 40, "Aspicot", Type::INSECTE, Type::POISON, 0, 7, new E_Level(14, 7),evs[13], 0.3, 3.2, "Son aiguillon empoisonné est très dangereux. Son corps est coloré afin de repousser ses ennemis.", 52, 1000000, 255, 13);
		 listePoke[14] = new Espece(25, 50, 25, 25, 35, 45, "Coconfort", Type::INSECTE, Type::POISON, 0, 10, new E_Level(15, 10), evs[14], 0.6, 10, "Incapable de se déplacer de lui-mÃªme, il se défend en durcissant sa carapace.", 71, 1000000, 120, 14);
		 listePoke[15] = new Espece(80, 40, 45, 80, 75, 65, "Dardargnan", Type::INSECTE, Type::POISON, 0, -1, ne, evs[15], 1, 29.5, "Il se sert de ses trois aiguillons empoisonnés pour attaquer sans relâche ses adversaires.", 159, 1000000, 45, 15);
		 listePoke[16] = new Espece(45, 40, 35, 35, 56, 40, "Roucool", Type::NORMAL, Type::VOL, 0, 18, new E_Level(17, 18), evs[16], 0.3, 1., "Ce Pokémon docile préfère éviter le combat. Toutefois, il se montre très féroce quand on l'agresse.", 55, 1059860, 255, 16);
		 listePoke[17] = new Espece(60, 55, 50, 50, 71, 63, "Roucoups", Type::NORMAL, Type::VOL, 0, 36, new E_Level(18, 36), evs[17], 1.1, 30, "Il protège son territoire avec ardeur et repousse à  coup de bec tout intrus.", 113, 1059860, 120, 17);
		 listePoke[18] = new Espece(80, 75, 70, 70, 101, 83, "Roucarnage", Type::NORMAL, Type::VOL, 0, -1, ne, evs[18], 1.5, 39.5, "Roucarnage déploie ses ailes majestueuses pour effrayer ses ennemis. Il peut voler à  Mach 2.", 172, 1059860, 45, 18);
		 listePoke[19] = new Espece(56, 35, 25, 35, 72, 30, "Rattata", Type::NORMAL, Type::AUCUN, 0, 20, new E_Level(20, 20), evs[19], 0.3, 3.5, "Vivant là  où se trouve la nourriture, ce charognard passe ses journées à  la rechercher.", 57, 1000000, 255, 19);
		 listePoke[20] = new Espece(81, 60, 50, 70, 97, 55, "Rattatac", Type::NORMAL, Type::AUCUN, 0, -1, ne, evs[20], 0.7, 18.5, "Ses pattes arrière lui permettent de traverser les rivières. Il est toujours en quÃªte de nourriture.", 127, 1000000, 127, 20);
		 listePoke[21] = new Espece(60, 30, 31, 31, 70, 40, "Piafabec", Type::NORMAL, Type::VOL, 0, 20, new E_Level(22, 20), evs[21], 0.3, 2, "Il chasse les insectes dans les hautes herbes. Ses petites ailes lui permettent de voler très vite.", 58, 1000000, 255, 21);
		 listePoke[22] = new Espece(90, 65, 31, 31, 100, 65, "Rapasdepic", Type::NORMAL, Type::VOL, 0, -1, ne, evs[22]}, 1.2, 3, "Il vole à  très grande vitesse et attaque en chargeant son ennemi.", 162, 1000000, 90, 22);
		 listePoke[23] = new Espece(60, 44, 40, 54, 55, 35, "Abo", Type::POISON, Type::AUCUN, 0, 22, new E_Level(24, 22), evs[23], 2, 6.9, "Plus il est âgé, plus son corps est long. Il se love autour des arbres pour se reposer.", 62, 1000000, 255, 23);
		 listePoke[24] = new Espece(85, 69, 65, 79, 80, 60, "Arbok", Type::POISON, Type::NORMAL, 0, -1, ne, evs[24], 3.5, 65, "Pour apeurer ses ennemis, il gonfle sa poitrine et émet d'étranges sons avec sa bouche.", 147, 1000000, 90, 24);
		 listePoke[25] = new Espece(55, 40, 50, 50, 90, 35, "Pikachu", Type::ELECTRIQUE, Type::AUCUN, 0, -1, new E_Item(26, Item::getItem("Pierrefoudre")), evs[25], 0.4, 6, "Il élève sa queue pour surveiller les environs. Elle attire souvent la foudre dans cette position.", 82, 1000000, 190, 25);
		 listePoke[26] = new Espece(90, 55, 90, 80, 110, 60, "Raichu", Type::ELECTRIQUE, Type::AUCUN, 0, -1, ne, evs[26], 0., 30, "Il peut terrasser des ennemis bien plus imposants en libérant une décharge de 100 000 V.", 122, 1000000, 75, 26);
		 listePoke[27] = new Espece(75, 85, 20, 30, 40, 50, "Sabelette", Type::SOL, Type::AUCUN, 0, 22, new E_Level(28, 22),evs[27], 0.6, 12, "Il s'enterre et vit dans les sous-sols. S'il se sent menacé, il se met en boule pour se protéger.", 93, 1000000, 255, 27);
		 listePoke[28] = new Espece(100, 110, 45, 55, 65, 75, "Sablaireau", Type::SOL, Type::AUCUN, 0, -1, ne, evs[28], 1, 29.5, "Il se roule en boule hérissée de piques s'il est menacé, il peut ainsi s'enfuir ou attaquer.", 163, 1000000, 90, 28);
		 listePoke[29] = new Espece(47, 52, 40, 40, 41, 55, "Nidoran♂ ", Type::POISON, Type::AUCUN, 0, 16, new E_Level(30, 16), evs[29], 0.4, 7, "Petite et docile, elle se protège avec sa minuscule corne empoisonnée lorsqu'elle est attaquée.", 59, 1059860, 235, 29);
		 listePoke[30] = new Espece(62, 67, 55, 55, 56, 70, "Nidorina", Type::POISON, Type::AUCUN, 0, -1, new E_Item(31, Item::getItem("Pierre Lune")), evs[30], 0., 20, "La femelle a un tempérament doux. Elle émet des cris ultrasoniques capables de déstabiliser ses ennemis.", 117, 1059860, 120, 30);
		 listePoke[31] = new Espece(92, 87, 75, 85, 76, 90, "Nidoqueen", Type::POISON, Type::SOL, 0, -1, ne, evs[31], 1.3, 60, "Son corps est recouvert d'écailles en forme de pointes. Quand ce Pokémon s'énerve, ses pointes se dressent de faà§on menaà§ante.", 194, 1059860, 45, 31);
		 listePoke[32] = new Espece(57, 40, 40, 40, 50, 46, "Nidoran♀‚", Type::POISON, Type::AUCUN, 0, 16, new E_Level(33, 16), evs[32], 0.5, 9, "Il jauge le terrain en laissant ses oreilles dépasser de l'herbe. Il se défend avec sa corne toxique.", 60, 1059860, 235, 32);
		 listePoke[33] = new Espece(72, 57, 55, 55, 65, 61, "Nidorino", Type::POISON, Type::AUCUN, 0, -1,new E_Item(34, Item::getItem("Pierre Lune")), evs[33], 0.9, 19.5, "Très agressif, il est prompt à  répondre à  la violence. La corne sur sa tÃªte est venimeuse.", 118, 1059860, 120, 33);
		 listePoke[34] = new Espece(102, 77, 85, 75, 85, 81, "Nidoking", Type::POISON, Type::SOL, 0, -1, ne, evs[34], 1.4, 62, "Un coup de sa puissante queue peut briser un poteau téléphonique comme une allumette.", 195, 1059860, 45, 34);
		 listePoke[35] = new Espece(45, 48, 60, 65, 35, 70, "Mélofée", Type::FEE, Type::AUCUN, 0, -1, new E_Item(36, Item::getItem("Pierre Lune")), evs[35], 06, 7.5, "La lumière de la lune qu'il emmagasine dans ses ailes dorsales lui permet de flotter dans les airs.", 68, 800000, 150, 35);
		 listePoke[36] = new Espece(70, 73, 95, 90, 60, 95, "Mélodelfe", Type::FEE, Type::AUCUN, 0, -1, ne, evs[36], 1.3, 40, "Il aime le calme des montagnes. Son ouà¯e exceptionnelle entendrait une aiguille tomber à  1km.", 129, 8000000, 25, 36);
		 listePoke[37] = new Espece(41, 40, 50, 65, 65, 38, "Goupix", Type::FEU, Type::AUCUN, 0, -1, new E_Item(38, Item::getItem("Pierre Feu")), evs[37], 0.6, 9.9, "Avec l'âge, la fourrure de ses six queues devient de plus en plus belle et soyeuse. Elle est chaude au toucher.",63, 1000000, 190, 37);//TROP KAWAII!!!!
		 listePoke[38] = new Espece(76, 75, 81, 100, 100, 73, "Feunard", Type::FEU, Type::AUCUN, 0, -1, ne, evs[38], 1.1, 19.9, "Il a neuf longues queues et une fourrure qui brille comme de l'or. On dit qu'il peut vivre 1 000 ans.", 178, 1000000, 75, 38);
		 listePoke[39] = new Espece(45, 20, 45, 25, 20, 115, "Rondoudou", Type::NORMAL, Type::FEE, 0, -1, new E_Item(40, Item::getItem("Pierre Lune")), {evs[39], 0.5, 5.5, "En se gonflant, il peut chanter une longue berceuse qui endort inévitablement ses adversaires.", 76, 800000, 170, 39);
		 listePoke[40] = new Espece(70, 45, 85, 50, 45, 140, "Grodoudou", Type::NORMAL, Type::FEE, 0, -1, ne, evs[40], 1, 12, "En cas de danger, il gonfle d'air son corps doux et potelé dans des proportions gigantesques.", 109, 800000, 50, 40);
		 listePoke[41] = new Espece(45, 35, 30, 40, 55, 40, "Nosferapti", Type::POISON, Type::VOL, 0, 22, new E_Level(42, 22), evs[41], 0., 7.5, "Ce pokemon est détesté en raison de sa forte présence dans les grottes. Malgré le fait qu'il n'aie pas d'yeux, ce pokemon arrive a voir avec des utltrasons.", 54, 1000000, 255, 41);
		 listePoke[42] = new Espece(80, 70, 65, 75, 90, 75, "Nosferalto", Type::POISON, Type::VOL, 0, -1, new E_Love(0), evs[42], 1.6, 55, "Quand il se met à  sucer du sang, il ne s'arrÃªte qu'une fois rassasié. C'est un chasseur nocturne.", 171, 1000000, 90, 42);
		 listePoke[43] = new Espece(50, 55, 75, 65, 30, 45, "Mystherbe", Type::PLANTE, Type::POISON, 0, 21, new E_Level(44, 21), evs[43], 0.5, 5.4, "Le jour, il reste en sous-sol et évite le soleil. Il grandit en se baignant au clair de lune.", 78, 1059860, 255, 43);
		 listePoke[44] = new Espece(65, 70, 85, 75, 40, 60, "Ortide", Type::PLANTE, Type::POISON, 0, -1, new E_Item(45, Item::getItem("Pierre Plante")) , evs[44], 0., 8.6, "Il sent très mauvais ! Mais une personne sur 1 000 aime la puanteur de son corps nauséabond.", 132, 1059860, 120, 44);
		 listePoke[45] = new Espece(80, 85, 110, 90, 50, 75, "Rafflesia", Type::PLANTE, Type::POISON, 0, -1, ne, evs[45], 1.2, 18.6, "Il possède des pétales énormes. à chaque pas, ils sèment d'épais nuages de pollen toxique.", 184, 1059860, 45, 45);
		 listePoke[46] = new Espece(70, 55, 45, 55, 25, 35, "Paras", Type::INSECTE, Type::PLANTE, 0, 24, new E_Level(47, 24), evs[46], 0.3, 5.4, "Il s'enfouit sous terre pour ronger des racines afin de nourrir les champignons sur son dos.", 70, 1000000, 190, 46);
		 listePoke[47] = new Espece(95, 80, 60, 80, 30, 60, "Parasect", Type::INSECTE, Type::PLANTE, 0, -1, ne, evs[47], 1, 29.5, "Un champignon parasite plus gros que Parasect contrôle son corps. Il répand des spores empoisonnées.", 128, 1000000, 75, 47);
		 listePoke[48] = new Espece(55, 50, 40, 55, 45, 60, "Mimitoss", Type::INSECTE, Type::POISON, 0, 31, new E_Level(49, 31), evs[48], 1, 30, "Il vit à  l'ombre des grands arbres où il se nourrit d'insectes. Il est attiré par la lumière.", 75, 1000000, 190, 48);
		 listePoke[49] = new Espece(65, 60, 90, 75, 90, 70, "Aéromite", Type::INSECTE, Type::POISON,0, -1, ne, evs[49], 1.5, 12.5, "Les écailles qu'il sème ont le pouvoir de paralyser totalement un ennemi.", 138, 1000000, 75, 49);
		 listePoke[50] = new Espece(55, 25, 35, 45, 95, 10, "Taupiqueur", Type::SOL, Type::AUCUN, 0, 26, new E_Level(51, 26), evs[50], 0.2, 0., "Son épiderme est très fin. S'il est exposé au soleil, son sang se réchauffe, ce qui l'affaiblit.", 81, 1000000, 255, 50);
		 listePoke[51] = new Espece(80, 50, 50, 70, 120, 35, "Triopikeur", Type::SOL, Type::AUCUN, 0, -1, ne, evs[51], 0.7, 33.3, "Terriblement puissants, ils peuvent creuser un tunnel dans tout type de sol et jusqu'à  100 km de profondeur.", 153, 1000000, 50, 51);
		 listePoke[52] = new Espece(45, 35, 40, 40, 90, 40, "Miaouss", Type::NORMAL, Type::AUCUN, 0, 28, new E_Level(53, 28), evs[52], 0.4, 4.2, "Son regard s'anime à  la vue d'un objet brillant. C'est un Pokémon nocturne.", 69, 1000000, 255, 52);
		 listePoke[53] = new Espece(70, 60, 65, 65, 115, 65, "Persian", Type::NORMAL, Type::AUCUN, 0, -1, ne, evs[53], 1, 32, "Un Pokémon très snob. La taille du joyau qui orne son front alimente bien des débats parmi ses fans.", 148, 1000000, 90, 53);
		 listePoke[54] = new Espece(52, 48, 65, 50, 55, 50, "Psykokwak", Type::EAU, Type::AUCUN, 0, 33, new E_Level(55, 33), evs[54], 0., 19.6, "Il ne se souvient pas qu'il a des pouvoirs psy. C'est pour cela qu'il a l'air si confus.", 80, 1000000, 190, 54);
		 listePoke[55] = new Espece(82, 78, 95, 80, 85, 80, "Akwakwak", Type::EAU, Type::AUCUN, 0, -1, ne, evs[55], 1.7, 76.6, "Il apparaà®t dans les étendues d'eau au crépuscule. Si son front brille, il se sert de sa télékinésie.", 174, 1000000, 75, 55);
		 listePoke[56] = new Espece(80, 35, 35, 45, 70, 40, "Férosinge", Type::COMBAT, Type::AUCUN, 0, 28, new E_Level(57, 28),evs[56], 0.5, 2, "Il ne peut dissocier ses amis de ses ennemis et a tendance à  enrager lorsqu'on l'approche.", 74, 1000000, 190, 56);
		 listePoke[57] = new Espece(105, 60, 60, 70, 95, 65, "Colossinge", Type::COMBAT, Type::AUCUN, 0, -1, ne, evs[57], 1, 32, "Sa fureur prend fin quand il n'a plus personne à  frapper. Il est difficile d'en Ãªtre témoin.", 149, 1000000, 75, 57);
		 listePoke[58] = new Espece(70, 45, 70, 50, 60, 55, "Caninos", Type::FEU, Type::AUCUN, 0, -1, new E_Item(59, Item::getItem("Pierre Feu")),evs[58], 0.7, 19, "Il est courageux et fier. Il se dresse vaillamment devant ses ennemis mÃªme s'ils sont plus puissants.", 91, 1250000, 190, 58);
		 listePoke[59] = new Espece(110, 80, 100, 80 , 95, 90, "Arcanin", Type::FEU, Type::AUCUN, 0, -1, ne,evs[59], 1.9, 155, "Son aboiement est tout simplement majestueux. On ne peut que ramper à  ses pieds après l'avoir entendu.", 213, 1250000, 75, 59);
		 listePoke[60] = new Espece(50, 40, 40, 40, 90, 40, "Ptitard", Type::EAU, Type::AUCUN, 0, 25, new E_Level(61, 25), evs[60], 0.6, 12.4, "Sa peau est si mince qu'on voit ses organes internes. Il tient à  peine sur ses nouveaux pieds.", 77, 1059860, 255, 60);
		 listePoke[61] = new Espece(65, 65, 50, 50, 90, 65, "TÃªtarte", Type::EAU, Type::AUCUN, 0, -1, new E_Item(62, Item::getItem("Pierre Eau")), evs[61], 1, 20, " Ce Pokémon amphibie transpire continuellement quand il est hors de l'eau afin d'hydrater son corps.", 131, 1059860, 120, 61);
		 listePoke[62] = new Espece(95, 95, 70, 90, 70, 90, "Tartard", Type::EAU, Type::COMBAT, 0, -1, ne, evs[62], 1.3, 54, "Il possède de sacrés biscoteaux. Il peut parcourir sans relâche l'Océan Pacifique.", 185, 1059860, 45, 62);
		 listePoke[63] = new Espece(20, 15, 105, 55, 90, 25, "Abra", Type::PSY, Type::AUCUN, 0, 16, new E_Level(64, 16), evs[63], 0.9, 19.5, "Il prévoit les attaques futures et se téléporte pour se mettre à  l'abri et éviter le combat.", 75, 1059860, 200, 63);
		 listePoke[64] = new Espece(35, 30, 120, 70, 105, 40, "Kadabra", Type::PSY, Type::AUCUN, 0, -1, new E_Trade(65), evs[64], 1.3, 56.5, "En utilisant ses pouvoirs, il émet des ondes alphas et cause des distorsions électroniques.", 145, 1059860, 100, 64);
		 listePoke[65] = new Espece(50, 45, 135, 95, 120, 55, "Alakazam", Type::PSY, Type::AUCUN, 0, -1, ne, evs[65], 1.5, 4, "Son cerveau hors du commun peut effectuer des opérations à  la vitesse d'un ordinateur. Il a un QI de 5 000.", 186, 1059860, 50, 65);
		 listePoke[66] = new Espece(80, 50, 35, 35, 35, 70, "Machoc", Type::COMBAT, Type::AUCUN, 0, 28, new E_Level(67, 28), evs[66], 0., 19.5, "Son corps est essentiellement composé de muscles. MÃªme s'il a la taille d'un petit enfant, il peut soulever 100 adultes avec ses bras.", 75, 1059860, 180, 66);
		 listePoke[67] = new Espece(100, 70, 50, 60, 45, 80, "Machopeur", Type::COMBAT, Type::AUCUN, 0, -1, new E_Trade(68), evs[67], 1.5, 70.5, "Son corps est si puissant qu'il lui faut une ceinture de force pour équilibrer ses mouvements.", 146, 1059860, 90, 67);
		 listePoke[68] = new Espece(130, 80, 65, 85, 55, 90, "Mackogneur", Type::COMBAT, Type::AUCUN, 0, -1, ne,evs[68], 1.6, 130, "Ses deux paires de bras permettent à  Mackogneur d'envoyer une série de 1000 coups de poing en 2s.", 193, 1059860, 45, 68);
		 listePoke[69] = new Espece(75, 35, 70, 30, 40, 50, "Chétiflor", Type::PLANTE, Type::POISON, 0, 21, new E_Level(70, 21), evs[69], 0.7, 4, "Son bourgeon ressemble à  un visage humain. Selon la légende, Chétiflor serait un type de mandragore légendaire.", 84, 1059860, 255, 69);
		 listePoke[70] = new Espece(90, 50, 85, 45, 55, 65, "Boustiflor", Type::PLANTE, Type::POISON, 0, -1, new E_Item(71, Item::getItem("Pierre Plante")), evs[70], 1, 6.4, "Il crache de la Poudre Toxik pour immobiliser sa proie et il l'achève avec de l'Acide.", 151, 1059860, 120, 70);
		 listePoke[71] = new Espece(105, 65, 100, 70, 70, 80, "Empiflor", Type::PLANTE, Type::POISON, 0, -1, ne, evs[71], 1.7, 15.5, "Tout corps ingéré par ce Pokémon est systématiquement dissout en bouillie.", 191, 1059860, 45, 71);
		 listePoke[72] = new Espece(40, 35, 50, 100, 70, 40, "Tentacool", Type::EAU, Type::POISON, 0, 30, new E_Level(73, 30),evs[72], 0.9, 45.5, "Il vit en bord de mer. Les pÃªcheurs se font souvent arroser d'acide quand ils en accrochent un.", 105, 1250000, 190, 72);
		 listePoke[73] = new Espece(70, 65, 80, 120, 100, 80, "Tentacruel", Type::EAU, Type::POISON, 0, -1, ne, evs[73], 1.6, 55, "Ses tentacules sont rétractés au repos. En situation de chasse, ils s'allongent pour prendre ses proies au piège.", 205, 1250000, 60, 73);
		 listePoke[74] = new Espece(80, 100, 30, 30, 20, 40, "Racaillou", Type::ROCHE, Type::SOL, 0, 25, new E_Level(75, 25),evs[74], 0.4, 20, "Il vit dans les plaines ou les montagnes. On le confond souvent avec un petit caillou.", 73, 1059860, 255, 74);
		 listePoke[75] = new Espece(95, 115, 45, 45, 35, 55, "Gravalanch", Type::ROCHE, Type::SOL, 0, -1, new E_Trade(76), evs[75], 1, 105, "D'une nature téméraire, il se moque de perdre des parties de son corps quand il dévale les pentes.", 134, 1059860, 120, 75);
		 listePoke[76] = new Espece(120, 130, 55, 65, 45, 80, "Grolem", Type::ROCHE, Type::SOL, 0, -1, ne, evs[76], 1.4, 300, "Aucun explosif ne pourrait entamer sa carapace de pierre. Il mue une fois par an.", 177, 1059860, 45, 76);
		 listePoke[77] = new Espece(85, 55, 65, 65, 90, 50, "Ponyta", Type::FEU, Type::AUCUN, 0, 40, new E_Level(48, 40),evs[77], 1, 30, "    Chancelantes à  la naissance, ses pattes deviennent très vite sà»res et solides à  force de galoper.", 152, 1000000, 190, 77);
		 listePoke[78] = new Espece(100, 70, 80, 80, 105, 65, "Galopa", Type::FEU, Type::AUCUN, 0, -1, ne, evs[78], 1.7, 95, "Au grand galop, sa crinière de feu disperse au vent une myriade d'étincelles ardentes.", 192, 1000000, 60, 78);
		 listePoke[79] = new Espece(65, 65, 40, 40, 15, 90, "Ramoloss", Type::EAU, Type::PSY, 0, 37, new E_Level(80, 37), evs[79], 1.2, 36, "Il est tellement paresseux qu'il lui faut une journée pour remarquer qu'on lui mord la queue.", 99, 1000000, 190, 79);
		 listePoke[80] = new Espece(75, 110, 100, 80, 30, 95, "Flagadoss", Type::EAU, Type::PSY, 0, -1, ne, evs[80], 1.6, 78.5, "Le Kokiyas accroché à  sa queue est friand de ce qu'il dévore et ne veut pas lâcher prise.", 164, 1000000, 75, 80);
		 listePoke[81] = new Espece(35, 70, 95, 55, 45, 25, "Magneti", Type::ELECTRIQUE, Type::ACIER, 0, 30, new E_Level(81, 30), evs[81],0.3, 6, "Les parties sur les côtés de son corps génèrent une énergie lui permettant de léviter.", 89, 1000000, 190, 81);
		 listePoke[82] = new Espece(60, 95, 120, 70, 70, 50, "Magnéton", Type::ELECTRIQUE, Type::ACIER, 0, -1, new E_Land(0, "Grotte Electrac"), evs[82], 1, 60, "Des groupes apparaissent si des taches solaires couvrent le soleil. Il brouillent les télévisions.", 161, 1000000, 60, 82);
		 listePoke[83] = new Espece(65, 55, 58, 62, 52, 52, "Canarticho", Type::NORMAL, Type::VOL, 0, -1, ne, evs[83], 0., 15, "Il utilise le légume qu'il tient comme s'il s'agissait d'une épée.", 94, 1000000, 45, 83);
		 listePoke[84] = new Espece(85, 45, 35, 35, 75, 35, "Doduo", Type::NORMAL, Type::VOL, 0, 31, new E_Level(31, 85), evs[84], 1.4, 39.2, "Ses deux cerveaux semblent communiquer leurs émotions grâce à  un lien télépathique.", 96, 1000000, 190, 84);
		 ...
		 listePoke[97] = new Espece(73, 70, 73, 115, 67, 85, "Hypnomade", Type::PSY, Type::AUCUN, 0, -1, ne, {Stats.DEFSPE, Stats.DEFSPE}, 1, 75, "La vue de son pendule oscillant endort en trois secondes, même quand on vient de se réveiller.", 165, 1000000, 75, 97);
		 ...
		 listePoke[100] = new Espece(30, 50, 55, 55, 100, 40, "Voltorbe", Type::ELECTRIQUE, Type::AUCUN, 0, 30,new E_Level(101, 30), {Stats.ATK, Stats.ATK}, 0.5, 10.4, "DÃ©couvert en mÃªme temps que les Poké Balls. Il parait qu'il existe un lien entre les deux.", 103, 1000000, 190, 100);
		 ...
		 listePoke[113] = new Espece(5, 5, 35, 105, 50, 250, "Leveinard", Type::NORMAL, Type::AUCUN,0, -1, ne, {Stats.PV, Stats.PV}, 1.1, 34.6, "Il est censé apporter la joie. Ce Pokémon charitable offre ses oeufs aux blessés.", 395, 800000, 30, 113);
		 ...
		 listePoke[115] = new Espece(95, 80, 40, 80, 90, 105, "Kangourex", Type::NORMAL, Type::AUCUN, 0, -1, ne, {Stats.PV, Stats.PV}, 2.2, 80, "Il élève ses petits dans sa poche ventrale. Il attend d'être en lieu sà»r pour les laisser jouer dehors.", 175, 1000000, 45, 115);
		 ...
		 listePoke[120] = new Espece(45, 55, 70, 55, 85, 30, "Stari", Type::EAU, Type::AUCUN, 0, -1, new E_Item(121, Item::getItem("Pierre Eau")), {Stats.VIT}, 0., 34.5, "MÃªme si son corps est détruit, il peut se régénérer aussi longtemps que son coeur est en bon état.", 106, 1250000, 225, 120);
