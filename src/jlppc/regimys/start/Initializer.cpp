...
namespace Initializer {
	...
	void initOpMons() {
		...
		using namespace Evolutions;
		 ...
		 listeOp[7] = new Espece(25, 35, 50, 54, 73, 44, "Picolphin", Type::EAU, Type::AUCUN, 0, 16, new E_Level(8, 16), evs[7], 0.5, 9, "Il adore nager en compagnie d'autres Picolphins", 66, 1059860, 45, 7);
		 listeOp[8] = new Espece(63, 80, 65, 80, 110, 59, "Deaulfin", Type::EAU, Type::AUCUN, 0, 36, new E_Level(9, 36), evs[8], 1, 22.5,"Il peut cracher de l'eau grâce à sa nageoire dorsale, mais le jet n'est pas très puissant, il doit donc compter sur sa vitesse pour attaquer plus", 143, 1059860, 45, 8);
		 ...
		 listeOp[12] = new Espece(105, 40, 70, 80, 75, 55, "Milleparterre", Type::INSECTE, Type::COMBAT, 0, -1, ne, {Stats.ATKSPE,evs[12],1.1, 32, "Ses ailes sont recouvertes d'une poudre les protégeant de la pluie. Ce Pokémon peut donc voler pendant de grosses averses.", 160, 1000000, 45, 12);
		 ...
		 listeOp[15] = new Espece(80, 40, 45, 80, 75, 65, "Assautrèle", Type::INSECTE, Type::COMBAT, 0, -1, ne, evs[15], 1, 29.5, "Il se sert de ses trois aiguillons empoisonnés pour attaquer sans relâche ses adversaires.", 159, 1000000, 45, 15);
		 ...
		 listeOp[18] = new Espece(80, 75, 50, 40, 190, 85, "Majelanion", Type::NORMAL, Type::VOL, 0, -1, ne, evs[18], 1.5, 39.5, "Il adore attrapper des Ornitaupes en vol, sa vitesse et tellement forte que son corp siffle pednant son vol", 172, 1059860, 45, 18);
		 ...
		 listeOp[20] = new Espece(81, 60, 50, 70, 97, 55, "Ornitank", Type::NORMAL, Type::EAU, 0, -1, ne, evs[20], 1.5, 38.5, "Il tire des balles grâce à son ventre, cela peut transpercer une montagne.", 127, 1000000, 127, 20);
		 ...
		 listeOp[22] = new Espece(160, 65, 31, 31, 10, 95, "Himondelle", Type::POISON, Type::VOL, 0, -1, ne, evs[22]}, 1.9, 190, "Cet OPMon plutôt imposant, ne peut plus voler depuis qu'il a évoluer, cela resulte d'un manque de migrations du à l'abondance d'insectes dans cette région", 162, 1000000, 90, 22);
		 listeOp[23] = new Espece(60, 44, 40, 54, 55, 35, "Serpiterre", Type::SOL, Type::TENEBRES, 0, 22, new E_Level(24, 22), evs[23], 2, 6.9, "Plus il est âgé, plus son corps est long. Il se nourrit de spectres nocturnes caché sous terre", 62, 1000000, 255, 23);
		 listeOp[24] = new Espece(85, 69, 65, 79, 80, 60, "Serpenair", Type::VOL, Type::TENEBRES, 0, -1, ne, evs[24], 3.5, 65, "Il adore planer au dessus des ses proies, les fantomes de nuits, pour jouer avec eux, avant de les aspirer.", 147, 1000000, 90, 24);
		 ...
		 listeOp[26] = new Espece(200, 55, 90, 80, 110, 60, "Cielectrik", Type::ELECTRIQUE, Type::AUCUN, 0, -1, ne, evs[26], 0., 30, "Il peut terrasser tout ses en libérant un décharge foudroyante plus de 550 000 V.", 122, 1000000, 65, 26);
