...
namespace Initializer {
	...
	void initOpMons() {
		...
		using namespace Evolutions;
		 ...
		 listeOp[7] = new Espece(25, 35, 50, 54, 73, 44, "lphin", Type::EAU, Type::AUCUN, 0, 16, new E_Level(8, 16), evs[7], 0.5, 9, "Il adore nager en compagnie d'autres Picolphins", 66, 1059860, 45, 7);
