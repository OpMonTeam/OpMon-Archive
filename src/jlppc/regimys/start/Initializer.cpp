...
void initOpMons() {
    ...
    listOp[3] = new Species(82, 83, 100, 100, 80, 80, "Toxiris", Type::PLANTE, Type::POISON, 0, -1, nullptr, evs[3], 2, 100, "Cet OpMon a la capacité de laché son poison a une vitesse exeptionnelle", 236, 1059860, 45, 3);
    ...
    listOp[6] = new Species(84, 78, 109, 85, 100, 78, "Enflammatorche", Type::FEU, Type::VOL, 0, -1, nullptr, evs[6], 3.7, 90.5, "Le feu qui sort de son crâne est peu très vite detruire tout sur son passage", 209, 1059860, 45, 6);
    ...
    listOp[9] = new Species(120, 80, 75, 105, 30, 109, "Roileine", Type::EAU, Type::NOTHING, 0, -1,nullptr, evs[9], 1.6, 85.5, "Il est le roi des océans de la région, il est capable de manger n'importe quoi, n'importe ou.", 210, 1059860, 45, 9);
    ...
    listOp[12] = new Species(105, 40, 70, 80, 75, 55, "Millepaterre", Type::INSECTE, Type::COMBAT, 0, -1, nullptr, evs[12], 1.1, 32, "Cet OPMon contient plus d'un millier de petits pattes collantes, ce qui lui permet de se déplacer partout", 160, 1000000, 45, 12);
    ...
    listOp[15] = new Species(80, 40, 45, 80, 75, 65, "Assautrèle", Type::INSECTE, Type::COMBAT, 0, -1, nullptr, evs[15], 1, 29.5, "Il se sert de ses trois aiguillons empoisonnés pour attaquer sans relâche ses adversaires.", 159, 1000000, 45, 15);
    ...
    listOp[18] = new Species(80, 75, 50, 40, 190, 85, "Majelanion", Type::NORMAL, Type::VOL, 0, -1, nullptr, evs[18], 1.5, 39.5, "Il adore attrapper des Ornitaupes en vol, sa vitesse et tellement forte que son corp siffle pednant son vol", 172, 1059860, 45, 18);
    ...
    listOp[20] = new Species(81, 60, 50, 70, 97, 55, "Ornitank", Type::NORMAL, Type::EAU, 0, -1, nullptr, evs[20], 1.5, 38.5, "Il tire des balles grâce à son ventre, cela peut transpercer une montagne.", 127, 1000000, 127, 20);
    ...
    listOp[22] = new Species(160, 65, 31, 31, 10, 95, "Himondelle", Type::POISON, Type::VOL, 0, -1, nullptr, evs[22], 1.9, 190, "Cet OPMon plutôt imposant, ne peut plus voler depuis qu'il a évoluer, cela resulte d'un manque de migrations du à l'abondance d'insectes dans cette région", 162, 1000000, 90, 22);
    ...
    listOp[24] = new Species(85, 69, 65, 79, 80, 60, "Serpenair", Type::VOL, Type::TENEBRES, 0, -1, nullptr, evs[24], 3.5, 65, "Il adore planer au dessus des ses proies, les fantomes de nuits, pour jouer avec eux, avant de les aspirer.", 147, 1000000, 90, 24);
    ...
    listOp[26] = new Species(200, 55, 90, 80, 110, 60, "Cielectrik", Type::ELECTRIQUE, Type::NOTHING, 0, -1, nullptr, evs[26], 0., 30, "Il peut terrasser tout ses en libérant un décharge foudroyante plus de 550 000 V.", 122, 1000000, 65, 26);
    ...
    listOp[29] = new Species(110, 96, 92, 74, 72, 84, "Calcinours", Type::FEU, Type::COMBAT, 0, -1, nullptr, evs[29], 2.6, 588, "Cet ours serait capable de mettre à feu et à sang n'importe quoi.", 172, 1250000, 172, 29);
