...
namespace Initializer {
	...
	void initOpMons() {
		...
		using namespace Evolutions;
		 ...
		 listeOp[7] = new Espece(25, 35, 50, 54, 73, 44, "Picolphin", Type::EAU, Type::AUCUN, 0, 16, new E_Level(8, 16), evs[7], 0.5, 9, "Il adore nager en compagnie d'autres Nanolphins", 66, 1059860, 45, 7);
		 ...
		 listeOp[29] = new Espece(110, 96, 92, 74, 72, 84, "Oursifournaise", Type::FEU, Type::COMBAT, 0, -1, NULL, evs[29], 2.6, 588, "Cet ours serait capable de mettre à feu et à sang n'importe quoi.", 172, 1250000, 172, 29);
