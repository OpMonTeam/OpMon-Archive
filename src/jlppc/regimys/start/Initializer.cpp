...
#define FREE_TAB(pointerName, sizeY) \
    ...
    */
    ...
    townMusics[1]->openFromFile(RESSOURCES_PATH + "audio/music/intro.ogg");
#endif // _WIN32
    TAB_TO_POINTER(Collisions::laboCol, laboColF, 16, 32);
    maps.push_back(new Map(Maps::laboLayer1, Maps::laboLayer2, Maps::laboLayer3, 32, 16, laboColF, townMusics[1]));
    FREE_TAB(laboColF, 16);
