...
void initOpMons() {
    ...
    listeOp[1] = new Espece(49, 49, 65, 65, 45, 45, "Rosarin", Type::PLANTE, Type::POISON, 0, 16, new E_Level(2, 16), evs[1], 0.7, 6.9, "L'amour de cet OpMon est incroyable, il ne demande que d'affection.", 64, 1059860, 45, 1);
    listeOp[2] = new Espece(62, 63, 80, 80, 60, 60, "Poisiplante",Type::PLANTE, Type::POISON, 0, 32, new E_Level(3, 32), evs[2], 1, 13, "Cet OpMon est extrememnt puissant, il empoisonne de façon violente tout ce qui passe sur son chemin.", 141, 1059860, 45, 2);
    listeOp[3] = new Espece(82, 83, 100, 100, 80, 80, "Toxiris", Type::PLANTE, Type::POISON, 0, -1, NULL, evs[3], 2, 100, "Cet OpMon a la capacité de laché son poison a une vitesse exeptionnelle", 236, 1059860, 45, 3);
    listeOp[4] = new Espece(52, 43, 60, 50, 65, 39, "Titbraise", Type::FEU, Type::NOTHING, 0, 16, new E_Level(5, 16), evs[4], 0.2, 2.3, "C'est l'un des plus petit monstres de ce monde, il est assez inssignifiant mais il fait très mal quand il le veux", 65, 1059860, 45, 4);
    listeOp[5] = new Espece(64, 58, 80, 65, 80, 58, "Rouxiflamme", Type::FEU, Type::NOTHING, 0, 36, new E_Level(6, 36), evs[5], 1.1, 19, "Quand cette créature attaque, elle rougit de toute ses forces pour bruler son adversaire", 142, 1059860, 45, 5);
    listeOp[6] = new Espece(84, 78, 109, 85, 100, 78, "Enflammatorche", Type::FEU, Type::VOL, 0, -1, NULL, evs[6], 3.7, 90.5, "Le feu qui sort de son crâne est peu très vite detruire tout sur son passage", 209, 1059860, 45, 6);
    listeOp[7] = new Espece(25, 35, 50, 54, 73, 44, "Nanolphin", Type::EAU, Type::NOTHING, 0, 16, new E_Level(8, 16), evs[7], 0.5, 9, "Il adore nager en compagnie d'autres Nanolphins", 66, 1059860, 45, 7);
    listeOp[8] = new Espece(63, 80, 65, 80, 110, 59, "Deaulfin", Type::EAU, Type::NOTHING, 0, 36, new E_Level(9, 36), evs[8], 1, 22.5,"Il peut cracher de l'eau grâce à sa queue, le jet est tellement puissant qu'il peut se déplacer sur terre", 143, 1059860, 45, 8);
    listeOp[9] = new Espece(120, 80, 75, 105, 30, 109, "Roileine", Type::EAU, Type::NOTHING, 0, -1,NULL, evs[9], 1.6, 85.5, "Il est le roi des océans de la région, il est capable de manger n'importe quoi, n'importe ou.", 210, 1059860, 45, 9);
    listeOp[10] = new Espece(30, 35, 20, 20, 45, 45, "Verpomme", Type::INSECTE, Type::NOTHING, 0, 7, new E_Level(11, 7), evs[10], 0.3, 2.9, "Ses pattes ont des ventouses lui permettant de grimper sur toute surface, notamment les arbres.", 53, 1000000, 255, 10);
    listeOp[11] = new Espece(20, 55, 25, 25, 30, 50, "Terrapatte", Type::INSECTE, Type::NOTHING, 0, 10, new E_Level(12, 10), evs[11], 0.7, 9.9, "Son corps frêle est protégé par sa carapace d'acier. Il encaisse les coups durs en attendant d'évoluer.", 72, 1000000, 120, 11);
    ...
    listeOp[13] = new Espece(35, 30, 20, 20, 50, 40, "Sautinelle", Type::INSECTE, Type::NOTHING, 0, 7, new E_Level(14, 7),evs[13], 0.3, 3.2, "Son aiguillon empoisonné est très dangereux. Son corps est coloré afin de repousser ses ennemis.", 52, 1000000, 255, 13);
    ...
    listeOp[23] = new Espece(60, 44, 40, 54, 55, 35, "Serpiterre", Type::SOL, Type::TENEBRES, 0, 24, new E_Level(24, 22), evs[23], 2, 6.9, "Plus il est âgé, plus son corps est long. Il se nourrit de spectres nocturnes caché sous terre", 62, 1000000, 255, 23);
    listeOp[24] = new Espece(85, 69, 65, 79, 80, 60, "Serpenair", Type::VOL, Type::TENEBRES, 0, -1, NULL, evs[24], 3.5, 65, "Il adore planer au dessus des ses proies, les fantomes de nuits, pour jouer avec eux, avant de les aspirer.", 147, 1000000, 90, 24);
    listeOp[25] = new Espece(55, 40, 50, 50, 90, 35, "Nucléage", Type::ELECTRIQUE, Type::NOTHING, 0, -1, new E_Item(26, Item::getItem("Invocation de la foudre")), evs[25], 7.4, 6, "Ce nuage s'amuse à viser les monuments ou objets très grands, ils sont à l'origine des éclairs aleatoires dans le ciel. Ils aiment se caché parmi les vraies nuages", 82, 1000000, 100, 25);
    listeOp[26] = new Espece(200, 55, 90, 80, 110, 60, "Cielectrik", Type::ELECTRIQUE, Type::NOTHING, 0, -1, NULL, evs[26], 0., 30, "Il peut terrasser tout ses en libérant un décharge foudroyante plus de 550 000 V.", 122, 1000000, 65, 26);
    listeOp[27] = new Espece(60, 58, 30, 52, 33, 65, "Oursiflamme", Type::FEU, Type::NOTHING, 0, 28, new E_Level(19, 28),evs[27], 0.5, 20, "Un si gentil ourson qui est tout feu tout flamme.", 93, 1000000, 45, 27);
    listeOp[28] = new Espece(80, 75, 60, 59, 54, 78, "Oursibraise", Type::FEU, Type::NOTHING, 0, 29, new E_Level(37,29), evs[28], 1.1, 29.5, "Cet ours est colérique, un rien peut lui mettre le feu au poudre.", 122, 1000000, 60, 28);
    listeOp[29] = new Espece(110, 96, 92, 74, 72, 84, "Calcinours", Type::FEU, Type::COMBAT, 0, -1, NULL, evs[29], 2.6, 588, "Cet ours serait capable de mettre à feu et à sang n'importe quoi.", 172, 1250000, 172, 29);
    listeOp[30] = new Espece(62, 67, 55, 55, 26, 90, "Calame", Type::POISON, Type::EAU, 0, -1, new E_Item(31, Item::getItem("Pierre Eau")), evs[30], 0.9, 20, "Ce mignon petit OpMon asire les âmes de ses ennemis et les recrache pour les attaquer", 117, 1059860, 120, 30);
    ...
    listeOp[32] = new Espece(57, 40, 40, 40, 50, 46, "Nidoran♀‚", Type::POISON, Type::NOTHING, 0, 16, new E_Level(33, 16), evs[32], 0.5, 9, "Il jauge le terrain en laissant ses oreilles dépasser de l'herbe. Il se défend avec sa corne toxique.", 60, 1059860, 235, 32);
    listeOp[33] = new Espece(72, 57, 55, 55, 65, 61, "Nidorino", Type::POISON, Type::NOTHING, 0, -1,new E_Item(34, Item::getItem("Pierre Lune")), evs[33], 0.9, 19.5, "Très agressif, il est prompt à  répondre à  la violence. La corne sur sa tÃªte est venimeuse.", 118, 1059860, 120, 33);
    ...
    listeOp[35] = new Espece(45, 48, 60, 65, 35, 70, "Mélofée", Type::FEE, Type::NOTHING, 0, -1, new E_Item(36, Item::getItem("Pierre Lune")), evs[35], 06, 7.5, "La lumière de la lune qu'il emmagasine dans ses ailes dorsales lui permet de flotter dans les airs.", 68, 800000, 150, 35);
    listeOp[36] = new Espece(70, 73, 95, 90, 60, 95, "Mélodelfe", Type::FEE, Type::NOTHING, 0, -1, ne, evs[36], 1.3, 40, "Il aime le calme des montagnes. Son ouà¯e exceptionnelle entendrait une aiguille tomber à  1km.", 129, 8000000, 25, 36);
    listeOp[37] = new Espece(41, 40, 50, 65, 65, 38, "Goupix", Type::FEU, Type::NOTHING, 0, -1, new E_Item(38, Item::getItem("Pierre Feu")), evs[37], 0.6, 9.9, "Avec l'âge, la fourrure de ses six queues devient de plus en plus belle et soyeuse. Elle est chaude au toucher.",63, 1000000, 190, 37);//TROP KAWAII!!!!
    listeOp[38] = new Espece(76, 75, 81, 100, 100, 73, "Feunard", Type::FEU, Type::NOTHING, 0, -1, ne, evs[38], 1.1, 19.9, "Il a neuf longues queues et une fourrure qui brille comme de l'or. On dit qu'il peut vivre 1 000 ans.", 178, 1000000, 75, 38);
    ...
    listeOp[50] = new Espece(55, 25, 35, 45, 95, 10, "Taupiqueur", Type::SOL, Type::NOTHING, 0, 26, new E_Level(51, 26), evs[50], 0.2, 0., "Son épiderme est très fin. S'il est exposé au soleil, son sang se réchauffe, ce qui l'affaiblit.", 81, 1000000, 255, 50);
    listeOp[51] = new Espece(80, 50, 50, 70, 120, 35, "Triopikeur", Type::SOL, Type::NOTHING, 0, -1, ne, evs[51], 0.7, 33.3, "Terriblement puissants, ils peuvent creuser un tunnel dans tout type de sol et jusqu'à  100 km de profondeur.", 153, 1000000, 50, 51);
    */listeOp[52] = new Espece(45, 35, 40, 40, 90, 40, "Chagnon", Type::NORMAL, Type::PSY, 0, 28, new E_Level(53, 28), evs[52], 0.4, 4.2, "Son regard s'anime à  la vue d'un objet brillant. C'est un Pokémon assez mysterieu et rare", 69, 1000000, 10, 52);
    /*listeOp[53] = new Espece(70, 60, 65, 65, 115, 65, "Persian", Type::NORMAL, Type::NOTHING, 0, -1, ne, evs[53], 1, 32, "Un Pokémon très snob. La taille du joyau qui orne son front alimente bien des débats parmi ses fans.", 148, 1000000, 90, 53);
    listeOp[54] = new Espece(52, 48, 65, 50, 55, 50, "Psykokwak", Type::EAU, Type::NOTHING, 0, 33, new E_Level(55, 33), evs[54], 0., 19.6, "Il ne se souvient pas qu'il a des pouvoirs psy. C'est pour cela qu'il a l'air si confus.", 80, 1000000, 190, 54);
    ...
    listeOp[63] = new Espece(20, 15, 105, 55, 90, 25, "Abra", Type::PSY, Type::NOTHING, 0, 16, new E_Level(64, 16), evs[63], 0.9, 19.5, "Il prévoit les attaques futures et se téléporte pour se mettre à  l'abri et éviter le combat.", 75, 1059860, 200, 63);
    listeOp[64] = new Espece(35, 30, 120, 70, 105, 40, "Kadabra", Type::PSY, Type::NOTHING, 0, -1, new E_Trade(65), evs[64], 1.3, 56.5, "En utilisant ses pouvoirs, il émet des ondes alphas et cause des distorsions électroniques.", 145, 1059860, 100, 64);
    listeOp[65] = new Espece(50, 45, 135, 95, 120, 55, "Alakazam", Type::PSY, Type::NOTHING, 0, -1, ne, evs[65], 1.5, 4, "Son cerveau hors du commun peut effectuer des opérations à  la vitesse d'un ordinateur. Il a un QI de 5 000.", 186, 1059860, 50, 65);
    listeOp[66] = new Espece(80, 50, 35, 35, 35, 70, "Machoc", Type::COMBAT, Type::NOTHING, 0, 28, new E_Level(67, 28), evs[66], 0., 19.5, "Son corps est essentiellement composé de muscles. MÃªme s'il a la taille d'un petit enfant, il peut soulever 100 adultes avec ses bras.", 75, 1059860, 180, 66);
    listeOp[67] = new Espece(100, 70, 50, 60, 45, 80, "Machopeur", Type::COMBAT, Type::NOTHING, 0, -1, new E_Trade(68), evs[67], 1.5, 70.5, "Son corps est si puissant qu'il lui faut une ceinture de force pour équilibrer ses mouvements.", 146, 1059860, 90, 67);
    listeOp[68] = new Espece(130, 80, 65, 85, 55, 90, "Mackogneur", Type::COMBAT, Type::NOTHING, 0, -1, ne,evs[68], 1.6, 130, "Ses deux paires de bras permettent à  Mackogneur d'envoyer une série de 1000 coups de poing en 2s.", 193, 1059860, 45, 68);
    ...
    */listeOp[72] = new Espece(40, 35, 50, 100, 70, 40, "Coassdethé", Type::EAU, Type::POISON, 0, 30, new E_Level(73, 30),evs[72], 0.4, 4, "La tasse dans laquelle il vit est comme une carapace. Lorsqu'il s'énerve, celle ci dégage une vapeur brulante.", 105, 1250000, 190, 72);
    listeOp[73] = new Espece(70, 65, 80, 120, 100, 80, "Ebouillanthé", Type::EAU, Type::FEU, 0, -1, ne, evs[73], 1.6, 55, "Il vit dans les sources d'eau chaude. Les tâches rouges sur son corps dégagent constamment de la vapeur brulante, son dos a le même effet qu'un grill.", 205, 1250000, 60, 73);
    ...
    listeOp[77] = new Espece(85, 55, 65, 65, 90, 50, "Ponyta", Type::FEU, Type::NOTHING, 0, 40, new E_Level(48, 40),evs[77], 1, 30, "    Chancelantes à  la naissance, ses pattes deviennent très vite sà»res et solides à  force de galoper.", 152, 1000000, 190, 77);
    listeOp[78] = new Espece(100, 70, 80, 80, 105, 65, "Galopa", Type::FEU, Type::NOTHING, 0, -1, ne, evs[78], 1.7, 95, "Au grand galop, sa crinière de feu disperse au vent une myriade d'étincelles ardentes.", 192, 1000000, 60, 78);
    ...
    listeOp[96] = new Espece(48, 45, 43, 90, 42, 60, "Soporifik", Type::PSY, Type::NOTHING, 0, 26,new E_Level(97, 26), {Stats.DEFSPE}, 1, 32, "Si vous pensez avoir rÃªvé mais que vous ne vous en souvenez pas, c'est que Soporifik a tout mangé.", 102, 1000000, 190, 96);
    listeOp[97] = new Espece(73, 70, 73, 115, 67, 85, "Hypnomade", Type::PSY, Type::NOTHING, 0, -1, ne, {Stats.DEFSPE, Stats.DEFSPE}, 1, 75, "La vue de son pendule oscillant endort en trois secondes, même quand on vient de se réveiller.", 165, 1000000, 75, 97);
    listeOp[98] = new Espece(105, 90, 25, 25, 50, 30, "Krabby", Type::EAU, Type::NOTHING, 0, 28,new E_Level(99, 28), {Stats.ATK}, 0.4, 6.5, "Il creuse son terrier sur des plages sablonneuses. Ses pinces repoussent si on les brise.", 115, 1000000, 255, 98);
    listeOp[99] = new Espece(130, 115, 50, 50, 75, 55, "Kraboss", Type::EAU, Type::NOTHING, 0, -1, ne, {Stats.ATK, Stats.ATK}, 1.3, 60, "Sa pince devient énorme. S'il la soulève trop vite, il risque de perdre l'équilibre.", 206, 1000000, 60, 99);
    .listeOp[100] = new Espece(76, 54, 89, 48, 60, 150, "MagMortis", Type::FEU, Type::ROCHE, 0, -1,NULL, evs[100], 3.64, 532, "Cet Opmon oublié au fil du temps est à l'origine de la disparition d'une ancienne génération de monstres combattants.", 200, 1850000, 4, 100);
    listeOp[101] = new Espece(50, 70, 80, 80, 140, 60, "Electrode", Type::ELECTRIQUE, Type::NOTHING, 0, -1, ne, {Stats.VIT, Stats.VIT}, 1.2, 66.6, "Il stocke tellement d'énergie dans son corps qu'une simple secousse peut le faire exploser.", 150, 1000000, 60, 101);
    ...
    listeOp[104] = new Espece(50, 95, 40, 50, 35, 50, "Osselait", Type::SOL, Type::NOTHING, 0, 28,new E_Level(105, 28), {Stats.DEF}, 0.4, 6.5, "Il porte constamment le crâne de sa mère. Personne ne sait à  quoi il ressemble sans ce crâne.", 87, 1000000, 190, 104);
    ...
    listeOp[119] = new Espece(92, 65, 65, 80, 68, 80, "Poissoroy", Type::EAU, Type::NOTHING, 0, -1, ne, {Stats.ATK, Stats.ATK}, 1.3, 39, "Il niche dans les rochers du ruisseau qu'il évide avec sa corne. Il donnerait sa vie pour ses Ã…Â’ufs.", 170, 1000000, 60, 119);
    listeOp[120] = new Espece(45, 55, 70, 55, 85, 30, "Stari", Type::EAU, Type::NOTHING, 0, -1, new E_Item(121, Item::getItem("Pierre Eau")), {Stats.VIT}, 0., 34.5, "MÃªme si son corps est détruit, il peut se régénérer aussi longtemps que son coeur est en bon état.", 106, 1250000, 225, 120);
    listeOp[121] = new Espece(75, 85, 100, 85, 115, 60, "Staross", Type::EAU, Type::NOTHING, 0, -1, ne, {Stats.VIT, Stats.VIT}, 1.1, 80, "Son cÃ…Â“ur brille des couleurs de l'arc-en-ciel. On raconte que c'est une pierre précieuse.", 207, 1250000, 60, 121);
    ...
    listeOp[125] = new Espece(83, 87, 95, 85, 105, 65, "Elektek", Type::ELECTRIQUE, Type::NOTHING, 0, -1, ne, {Stats.VIT, Stats.VIT}, 1.1, 30, "Il adore se nourrir d'électricité. Il apparaà®t occasionnellement près des grandes centrales électriques.", 156, 1000000, 45, 125);
    listeOp[126] = new Espece(95, 57, 100, 85, 93, 65, "Magmar", Type::FEU, Type::NOTHING, 0, -1, ne, {Stats.ATKSPE, Stats.ATKSPE}, 1.3, 44.5, "On trouve ce Pokémon près des bouches de volcans. Son corps incandescent atteint 1 200 Ã‚Â°C.", 127, 1000000, 45, 126);
    listeOp[127] = new Espece(125, 100, 55, 70, 85, 65, "Scarabrute", Type::INSECTE, Type::NOTHING, 0, -1, ne, {Stats.ATK, Stats.ATK}, 1.5, 55, "Il attaque sauvagement avec ses cornes. En hiver, il se cache au plus profond des forÃªts.", 200, 1250000, 45, 127);
    ...
    listeOp[146] = new Espece(100, 90, 125, 85, 90, 90, "Sulfura", Type::FEU, Type::VOL, 0, -1, ne, {Stats.ATKSPE, Stats.ATKSPE, Stats.ATKSPE}, 2, 60, "C'est un Pokémon oiseau légendaire capable de contrôler le feu. On raconte que lorsqu'il est blessé, il se baigne dans le magma d'un volcan pour se soigner.", 217, 1250000, 3, 146);
            listeOp[147] = new Espece(64, 45, 50, 50, 50, 41, "Minidraco", Type::DRAGON, Type::NOTHING, 0, 0,new E_Level(148, 30), {Stats.ATK}, 1., 3.3, "Minidraco mue constamment, renouvelant sans arrÃªt sa peau. En effet, l'énergie vitale de son corps augmente régulièrement et sa mue lui permet d'éviter d'atteindre des niveaux incontrôlables.", 67, 1250000, 45, 147);
    listeOp[148] = new Espece(84, 65, 70, 70, 70, 61, "Draco", Type::DRAGON, Type::NOTHING, 0, 1,new E_Level(149, 55), {Stats.ATK, Stats.ATK}, 4, 16.5, "Draco stocke une quantité d'énergie considérable dans son corps. On raconte qu'il peut modifier les conditions climatiques autour de lui en déchargeant l'énergie contenue dans les cristaux de son cou et de sa queue.", 144, 1250000, 45, 148);
    ...
    listeOp[150] = new Espece(110, 90, 154, 90, 130, 106, "Mewtwo", Type::PSY, Type::NOTHING, 0, -1, ne, {Stats.ATKSPE, Stats.ATKSPE, Stats.ATKSPE}, 2, 122, "Il est le fruit de nombreuses expériences génétiques horribles et malsaines.", 220, 1250000, 3, 150);
        listeOp[151] = new Espece(100, 100, 100, 100, 100, 100, "Mew",  Type::PSY, Type::NOTHING, 0, -1, ne, {Stats.PV, Stats.PV, Stats.PV}, 0.4, 4, "Nombre de scientifiques voient en lui l'ancÃªtre des Pokémon car il maà®trise toutes leurs capacités.", 64, 1059860, 45, 151);
    listeOp[152] = new Espece(49, 65, 45, 69, 45, 45, "Germignon", Type::PLANTE, Type::NOTHING, 0, 16, new E_Level(153, 16), {Stats.DEFSPE}, 0.9, 6.4, "Un doux parfum émane de la feuille placée sur sa tÃªte. Il est très gentil et aime dormir au soleil.", 64, 1059860, 45, 152);
    listeOp[153] = new Espece(62, 80, 63, 80, 60, 60, "Macronium", Type::PLANTE, Type::NOTHING, 0, 32, new E_Level(154, 32), {Stats.DEF, Stats.DEFSPE}, 1.2, 15.,  "Le collier de bourgeons Ã  son cou répand un arÃ´me épicé qui vous donne du tonus", 141, 1059860, 45, 153);
    listeOp[154] = new Espece(82, 100, 83, 100, 80, 80 , "Méganium", Type::PLANTE, Type::NOTHING, 0, -1, ne, {Stats.DEF, Stats.DEFSPE,Stats.DEFSPE}, 1., 100.5, "L'arÃ´me qui émane de ses pétales contient une substance qui calme les pulsions sexuelles.", 208, 1059860, 45, 154);
    listeOp[155] = new Espece(52, 43, 60, 50, 65, 39 , "Héricendre", Type::FEU, Type::NOTHING, 0, 14, new E_Level(156, 14), {Stats.VIT}, 0.5, 7.9, " Il est timide et se roule en boule pour se protéger. Attaqué, il s'enflamme le dos pour riposter.", 65, 1059860, 45, 155);
    listeOp[156] = new Espece(64, 58, 80, 65, 80, 58 ,"Feurisson", Type::FEU, Type::NOTHING, 0, 36, new E_Level(157, 36), {Stats.ATKSPE, Stats.VIT}, 0.9, 19, "Avant chaque combat, il tourne le dos et montre la puissance de sa queue", 142, 1059860, 45, 156);
    listeOp[157] = new Espece(84, 78, 109, 85, 100, 78, "Typlosion", Type::FEU, Type::NOTHING, 0, -1, ne, {Stats.ATKSPE, Stats.ATKSPE, Stats.ATKSPE}, 1.7, 79.5, "Il a un coup secret dévastateur. En frottant sa fourrure ardente, il crée une forte explosion.", 209, 1059860, 45, 157);
    listeOp[158] = new Espece(65, 64, 44, 48, 43, 50, "Kaiminus", Type::EAU, Type::NOTHING, 0, 18, new E_Level(158, 18), {Stats.ATK}, 9,5, "Petit mais costaud, il n'hésite pas Ã  mordre tout ce qui passe Ã  portée de ses dents.", 66, 1059860, 45, 158);
    listeOp[159] = new Espece(80, 80, 59, 63, 58, 65, "Crocrodil", Type::EAU, Type::NOTHING, 0, 30, new E_Level(159, 30), {Stats.ATK, Stats.DEF}, 1.1, 25, "Quand il perd un croc, il en repousse un autre. Sa bouche est en permanence composée de 48 dents.", 143, 1059860, 45, 159);
    listeOp[160] = new Espece(105, 100, 79, 83, 78, 85, "Aligatueur", Type::EAU, Type::NOTHING, 0, -1, ne, {Stats.ATK, Stats.ATK, Stats.DEF}, 2.3, 88., "Ce Pokémon Ã  l'air pataud est capable d'attaquer Ã  la vitesse de l'éclair pour mordre sa proie.", 210, 1059860, 45, 160);
    listeOp[161] = new Espece(46, 34, 35, 45, 20, 35, "Fouinette", Type::NORMAL, Type::NOTHING, 0, 15, new E_Level(162, 15), {Stats.ATK}, 0., 6, "S'il fait le guet, il prévient les autres d'un danger en criant et en frappant avec sa queue le sol.", 57, 1000000, 255, 161);
    listeOp[162] = new Espece(76, 64, 45, 55, 90, 85, "Fouinar", Type::NORMAL, Type::NOTHING, 0, -1, ne, {Stats.VIT, Stats.VIT}, 1., 32.5, "Il fabrique un nid qui convient Ã  son corps très fin, et oÃ¹ lui seul peut entrer.", 116, 1000000, 90, 162);
    ...
    listeOp[172] = new Espece(40, 15, 35, 35, 60, 20, "Pichu", Type::ELECTRIQUE, Type::NOTHING, 0, -1, new E_Love(0), {Stats.VIT}, 0.3, 2, "Il ne sait pas encore stocker l'électricité. Il envoie des décharges par jeu ou par peur.", 42,1000000, 190, 172);
    ...
    listeOp[174] = new Espece(90, 30, 15, 40, 20, 15, "Toudoudou", Type::FEE, Type::NOTHING, 0, -1, new E_Love(0), {Stats.PV}, 0.3, 1, "Son corps est très doux. Quand il commence à rebondir, il est impossible de l'arrêter.", 45, 800000, 39, 174);
    listeOp[175] = new Espece(20, 65, 40, 65, 20, 35, "Togepi", Type::FEE, Type::NOTHING, 0, -1, new E_Item(175, Item::getItem("Bonheur")), {Stats.DEFSPE}, 0.3, 1.5, "Sa coquille est remplie de joie. On dit que s’il est bien traité, il porte chance.", 74, 800000, 190, 175);
    ...
    listeOp[179] = new Espece(55, 40, 40, 65, 45, 35, "Wattouat", Type::ELECTRIQUE, Type::NOTHING, 0, 15, new E_Level(180, 15), {Stats.ATKSPE}, 0.6, 7., "Sa laine fournie enfle lorsqu'il accumule de l'électricité statique. Son contact peut choquer.", 235, 1059860, 59, 179);
    listeOp[180] = new Espece(55, 55, 80, 60, 45, 70, "Lainergie", Type::ELECTRIQUE, Type::NOTHING, 0, 30, new E_Level (181, 30), {Stats.ATKSPE, Stats.ATKSPE}, 0., 13.3, "Sa queue s'allume lorsque sa laine se charge d'électricité. Il projette des poils électrifiés.", 117, 1059860, 120, 180);
    listeOp[181] = new Espece(75, 85, 115, 90, 55, 90, "Pharamp", Type::ELECTRIQUE, Type::NOTHING, 0, -1, ne, {Stats.ATKSPE, Stats.ATKSPE, Stats.ATKSPE}, 1.4, 61.5, "Le bout de sa queue brille si fort qu'il peut être vu de très loin. Il sert de balise aux gens.", 196, 1059860, 45, 181);
    listeOp[182] = new Espece(80, 85, 90, 100, 50, 75, "Joliflor", Type::PLANTE, Type::NOTHING, 0, -1, ne, {Stats.DEFSPE, Stats.DEFSPE, Stats.DEFSPE}, 0.4, 5., "Les Joliflor se réunissent souvent pour danser. On pense que c'est un rituel pour appeler le soleil", 184, 1059860, 45, 182);
    ...
    listeOp[185] = new Espece(100, 115, 30, 65, 30, 70, "Simularbre", Type::ROCHE, Type::NOTHING, 0, -1, ne, {Stats.DEF, Stats.DEF}, 1.4, 61.5, "Il se déguise en arbre pour éviter les problèmes. Il déteste l'eau et se cache par temps de pluie.", 135, 1059860, 65, 185);
    listeOp[186] = new Espece(75, 75, 90, 100, 70, 90, "Tarpaud", Type::EAU, Type::NOTHING, 0, -1, ne, {Stats.DEFSPE}, 1.1, 33.9, "Si Ptitard et Têtarte entendent son cri, ils se rassemblent pour venir le rencontrer.", 185, 1059860, 45, 186);
    ...
    listeOp[190] = new Espece(70, 55, 40, 55, 85, 55, "Capumain", Type::NORMAL, Type::NOTHING, 0, -1, ne, {Stats.VIT}, 0., 11.5, "Sa queue est si forte qu'il peut l'utiliser pour se suspendre aux branches des arbres.", 94, 800000, 45, 190);
    listeOp[191] = new Espece(30, 30, 30, 30, 30, 30, "Tournegrin", Type::PLANTE, Type::NOTHING, 0, -1, new E_Item(192, Item::getItem("Pierre Soleil")), {Stats.ATKSPE}, 0.3, 1., "Il tombe du ciel soudainement. S'il est attaqué par un Piafabec, il secoue violemment ses feuilles.", 52, 1059860, 235, 191);// ajoutez la pierre soleil
    listeOp[192] = new Espece(75, 55, 105, 85, 30, 75, "Héliatronc", Type::PLANTE, Type::NOTHING, 0, -1, ne, {Stats.ATKSPE, Stats.ATKSPE}, 0., 8.5, "À l'approche des beaux jours, les pétales entourant sa tête deviennent plus chatoyants.", 146, 1059860, 120, 192);
    ...
    listeOp[196] = new Espece(65, 60, 130, 95, 110, 65, "Mentali", Type::PSY, Type::NOTHING, 0, -1, new E_Nope(), {Stats.ATKSPE, Stats.ATKSPE}, 0.9, 26.5, "Sa fourrure ultraswagg détecte les vibrations de l'air. Il peut ainsi prédire le temps ou lire les pensées adverses.", 197, 1000000, 45, 196);
    listeOp[197] = new Espece(65, 110, 60, 130, 65, 95, "Noctali", Type::TENEBRES, Type::NOTHING, 0, -1, ne, {Stats.DEFSPE, Stats.DEFSPE}, 1, 27, "Quand il s'énerve, ses pores sécrètent une sueur empoisonnée qu'il envoie dans les yeux de ses ennemis.", 197, 1000000, 45, 197);
    ...
    listeOp[200] = new Espece(60, 60, 85, 85, 85, 60, "Feuforêve", Type::SPECTRE, Type::NOTHING, 0, -1, new E_Item(0, Item::getItem("Pierre Nuit")), {Stats.ATKSPE, Stats.DEFSPE}, 0.7, 1.0, "Il pousse des hurlements la nuit pour effrayer les gens.", 147, 800000, 45, 200);//Ajoutez la pierre nuit
    listeOp[201] = new Espece(72, 48, 72, 48, 48, 48, "Zarbi", Type::FEE, Type::NOTHING, 0, -1, ne, {Stats.ATK, Stats.ATKSPE}, 0.5, 5, "Son corps plat et fin est toujours collé aux murs. On pense que sa forme a une signification.", 61, 1000000, 225, 201);
    listeOp[202] = new Espece(33, 58, 33, 58, 33, 190, "Qulbutoké", Type::PSY, Type::NOTHING, 0, -1, ne, {Stats.PV, Stats.PV}, 1.3, 28.5, "Pour cacher sa queue imposante, il vit discrètement dans l'obscurité. Il n'attaque jamais le premier.", 177, 1000000, 45, 202);
    ...
    listeOp[204] = new Espece(65, 90, 35, 35, 15, 50, "Pomdepik", Type::INSECTE, Type::NOTHING, 0, 31, new E_Level(205, 31), {Stats.DEF}, 0.6, 7.2, "Il renforce sa carapace en y ajoutant des écorces d'arbre. Il devient alors plus lourd.", 60, 1000000, 190, 204);
    ...
    listeOp[206] = new Espece(70, 70, 65, 65,  45, 100, "Insolourdo", Type::NORMAL, Type::NOTHING, 0, -1, ne, {Stats.PV}, 1.5, 14, "Ce Pokemon mérite t'il vraiment une description ?", 125, 1000000, 190, 206);
    ...
    listeOp[209] = new Espece(80, 50, 40, 40, 30, 60, "Snubbull", Type::FEE, Type::NOTHING, 0, 23, new E_Level(210, 23), {Stats.PV}, 0.6, 7., "Il est d'une nature joviale. De nombreuses femmes l'apprécient pour sa gentillesse.", 63, 800000, 190, 209);
    listeOp[210] = new Espece(120, 75, 60, 60, 45, 90, "Granbull", Type::NOTHING, Type::FEE, 0, -1, ne, {Stats.ATK, Stats.ATK}, 1.4, 48.7, "Il peut faire fuir presque tous les Pokémon en ouvrant très largement sa mâchoire.", 178, 800000, 75, 210);
    ...
    listeOp[216] = new Espece(80, 50, 50, 50, 40, 60, "Teddiursa", Type::NORMAL, Type::NOTHING, 0, 30, new E_Level(217,30), {Stats.VIT}, 0.6, 8., "Il se fait des réserves de nourriture dans des cachettes avant l'arrivée de l'hiver.", 70, 1000000, 120, 216);
    listeOp[217] = new Espece(130, 75, 75, 75, 55, 90, "Ursaring", Type::NORMAL, Type::NOTHING, 0, -1, ne, {Stats.ATK, Stats.ATK}, 1., 125., "Bien que d'une large corpulence, il grimpe aux arbres pour s'y nourrir et y dormir.", 189, 1000000, 60, 217);
    listeOp[218] = new Espece(40, 40, 70, 40, 20, 40, "Limagma", Type::FEU, Type::NOTHING, 0, 38, new E_Level(219,38), {Stats.ATKSPE}, 0.7, 35, "Son corps est fait de magma. S'il cesse de bouger, il refroidit et durcit.", 78, 1000000, 190, 218);
    ...
    listeOp[223] = new Espece(65, 35, 65, 35, 65, 35, "Rémoraid", Type::EAU, Type::NOTHING, 0, 25,new E_Level(223, 25), {Stats.ATKSPE}, 0, 12, "Se servant de sa nageoire dorsale, il s'accroche sous un Démanta pour récupérer ses restes.", 78, 1000000,190, 223);
    ...
    listeOp[231] = new Espece(60, 60, 40, 40, 40, 40, "Phanpy", Type::SOL, Type::NOTHING, 0, 25,new E_Level(231, 25), {Stats.PV}, 1, 33, "Il se cogne sur celui ou celle qu'il apprécie. Il est cependant si fort qu'il fait souvent mal.", 124, 1000000, 45, 231);
    listeOp[232] = new Espece(120, 120, 60, 60, 50, 90, "Donphan", Type::SOL, Type::NOTHING, 0, -1, new E_Nope(), {Stats.ATK,Stats.DEF}, 1, 120, "Si Donphan décidait de charger, il pourrait détruire une maison. Grâce à sa force étonnante, ce Pokémon peut aider à déplacer les rochers et les coulées de boue qui bloquent les chemins de montagne.", 189, 1000000, 45, 232);//TAG : TODO : A vérifier : Taux de capture
    listeOp[233] = new Espece(80, 90, 105, 95, 60, 85, "Porygon2", Type::NORMAL, Type::NOTHING, 0, -1, ne, {Stats.ATKSPE, Stats.ATKSPE}, 0.6, 32.5, "Version évoluée de Porygon, créée dans l'espoir de pouvoir un jour terraformer des planètes, un rêve loin d'être concrétisé pour l'instant.", 180, 1000000, 45, 233);
    listeOp[234] = new Espece(95, 62, 85, 65, 85, 73, "Cerfrousse", Type::NORMAL, Type::NOTHING, 0, -1, ne, {Stats.ATK}, 1.4, 71.2, " Ce Pokémon fut chassé et l'espèce proche de l'extinction à cause des gens qui recherchaient leurs précieux bois.", 165, 1250000, 45, 234);
    listeOp[235] = new Espece(20, 35, 20, 45, 75, 55, "Quelorior", Type::NORMAL, Type::NOTHING, 0, -1, ne, {Stats.VIT}, 1.2, 5, "Ce Pokémon peint pour marquer son territoire. On reconnaît les villes peuplées de nombreux Queulorior à leurs murs recouverts de graffitis", 106, 800000, 45, 235);
    listeOp[236] = new Espece(35, 35, 35, 35, 35, 35, "Debugant", Type::COMBAT, Type::NOTHING, 0, -1, ne, {Stats.ATK, Stats.ATK}, 0.7, 21, "Pour augmenter ses capacités, il cherche à se battre contre n'importe qui. Il est très courageux.", 91, 1000000, 75, 236);//EVOLUTION A CORRIGER
    listeOp[237] = new Espece(95, 95, 35, 110, 70, 50, "Kapoera", Type::COMBAT, Type::NOTHING, 0, -1, ne, {Stats.DEFSPE, Stats.DEFSPE}, 1.4, 4, "Il combat en tournoyant comme une toupie. La force centrifuge décuple sa puissance destructrice.", 137, 1000000, 45, 237);//EVOLUTION A CORRIGER
    ...
    listeOp[239] = new Espece(63, 37, 65, 55, 95, 45, "Elekid", Type::ELECTRIQUE, Type::NOTHING, 0, 30, new E_Level(125,30), {Stats.VIT}, 0.6, 23.5, "Il génère de l'électricité en battant des bras, mais il n'a aucun moyen de stocker cette énergie.", 106, 1000000, 45, 239);
    listeOp[240] = new Espece(75, 37, 70, 55, 83, 45, "Magby", Type::FEU, Type::NOTHING, 0, 30, new E_Level (126,30), {Stats.VIT}, 0.7, 21.4, "Ce Pokémon est souvent aperçu dans les régions volcaniques. Donnez-lui à manger et il vous déclarera sa flamme... littéralement.", 117, 1000000, 45, 240);
    listeOp[241] = new Espece(80, 105, 40, 70, 100, 95, "Écrémeuh", Type::NORMAL, Type::NOTHING, 0, -1, ne, {Stats.VIT}, 1.2, 75.5, "Son lait est aussi nutritif qu'hypercalorique. A consommer avec modération", 200, 1250000, 45, 241);
    listeOp[242] = new Espece(10, 10, 75, 135, 55, 255, "Leuphorie", Type::NORMAL, Type::NOTHING, 0, -1, ne, {Stats.PV, Stats.PV, Stats.PV}, 1.5, 46., "Le pelage de ce Pokémon lui fait office de radar à émotions. Il est ainsi capable de capter les humeurs des Pokémon et humains alentour", 608, 800000, 30, 242);//
    listeOp[243] = new Espece(85, 75, 115, 110, 115, 90, "Raikou", Type::ELECTRIQUE, Type::NOTHING, 0, -1, ne, {Stats.ATKSPE, Stats.VIT, Stats.VIT}, 1.9, 17, "Le nuage de pluie qu'il porte peut relâcher la foudre à volonté. On dit de lui qu'il est venu avec l'orage.", 216, 1250000, 3, 243);
    listeOp[244] = new Espece(115, 85, 90, 75, 100, 115, "Entei", Type::FEU, Type::NOTHING, 0, -1, ne, {Stats.PV, Stats.ATK, Stats.ATK}, 2.1, 19, "Un Pokémon qui parcourt le monde. On dit qu'il en naît un à chaque fois qu'un volcan apparaît", 217, 1250000, 3, 244);
    listeOp[245] = new Espece(75, 115, 90, 115, 85, 100, "Suicune", Type::EAU, Type::NOTHING, 0, -1, ne, {Stats.DEF, Stats.DEFSPE, Stats.DEFSPE}, 2, 187, "Il serait la réincarnation du vent du nord. Il peut purifier instantanément les eaux polluées.", 216, 1250000, 3, 245);
...
void initMaps() {
    ...
    feE2.push_back("void");
    feE2.push_back("void");
    maps[0]->addEvent(new Events::TalkingEvent(alpha, std::vector<sf::Texture>(), sf::Vector2f(20, 7), feE2));
    std::vector<std::string> feE3;
    feE3.push_back("rivalHouse");
    feE3.push_back("void");
    feE3.push_back("void");
    maps[0]->addEvent(new Events::TalkingEvent(alpha, std::vector<sf::Texture>(), sf::Vector2f(24, 7), feE3));
    std::vector<std::string> feE4;
    feE4.push_back("labo");
    feE4.push_back("void");
    feE4.push_back("void");
    maps[0]->addEvent(new Events::TalkingEvent(alpha, std::vector<sf::Texture>(), sf::Vector2f(13, 19), feE4));
    std::vector<std::string> feE5;
    feE5.push_back("weirdsign.1");
