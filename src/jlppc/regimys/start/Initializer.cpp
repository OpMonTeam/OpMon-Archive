...
namespace Initializer {
	...
	void initOpMons() {
		...
		using namespace Evolutions;
		 ...
		 listeOp[19] = new Espece(56, 35, 25, 35, 72, 30, "Ornitaupe", Type::NORMAL, Type::EAU, 0, 20, new E_Level(20, 20), evs[19], 1.2, 7.5, "Cet OpMon creuse des tunels à l'aide de sa queue plate, grâce à cela, son espece a developper une forte puissance dans cette queue", 57, 1000000, 255, 19);
