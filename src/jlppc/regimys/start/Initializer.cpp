...
namespace Initializer {
	...
	void initOpMons() {
		...
		using namespace Evolutions;
		 ...
		 listeOp[29] = new Espece(110, 96, 92, 74, 72, 84, "Ournaise", Type::FEU, Type::COMBAT, 0, -1, NULL, evs[29], 2.6, 588, "Cet ours serait capable de mettre à feu et à sang n'importe quoi.", 172, 1250000, 172, 29);
