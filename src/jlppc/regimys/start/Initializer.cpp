...
namespace Initializer {
	...
	void initOpMons() {
		...
		using namespace Evolutions;
		 ...
		 listeOp[19] = new Espece(56, 35, 25, 35, 72, 30, "Ornitaupe", Type::NORMAL, Type::EAU, 0, 20, new E_Level(20, 20), evs[19], 1.2, 7.5, "Vivant là  où se trouve la nourriture, ce charognard passe ses journées à  la rechercher.", 57, 1000000, 255, 19);
		 listeOp[20] = new Espece(81, 60, 50, 70, 97, 55, "Ornitank", Type::NORMAL, Type::EAU, 0, -1, ne, evs[20], 1.5, 38.5, "Ses pattes arrière lui permettent de traverser les rivières. Il est toujours en quÃªte de nourriture.", 127, 1000000, 127, 20);
		 ...
		 listeOp[251] = new Espece(100, 100, 100, 100, 100, 100, "Clair de Lune", Type::LUMIERES, Type::TENEBRES, 0, -1, ne, {Stats.ATKSPE, Stats.DEFSPE, Stats.PV}, 0.4, 5, "Ce chat adorait contempler la lune chaque soir, une nuit, elle eu raison de lui", 300, 1250000, 3, ?);
		*/
	}
