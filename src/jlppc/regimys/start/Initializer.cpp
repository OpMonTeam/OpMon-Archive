...
namespace Initializer {
	...
	void initPokemons() {
		...
		using namespace Evolutions;
		 ...
		 listePoke[59] = new Espece(110, 80, 100, 80 , 95, 90, "Arcanin", Type::FEU, Type::AUCUN, 0, -1, ne, {Stats.ATK, Stats.ATK}, 1.9, 155, "Son aboiement est tout simplement majestueux. On ne peut que ramper à  ses pieds après l'avoir entendu.", 213, 1250000, 75, 59);
		 ...
		 listePoke[82] = new Espece(60, 95, 120, 70, 70, 50, "Magnéton", Type::ELECTRIQUE, Type::ACIER, 0, -1, new E_Land(0, "Grotte Electrac"), {Stats.ATKSPE, Stats.ATKSPE}, 1, 60, "Des groupes apparaissent si des taches solaires couvrent le soleil. Il brouillent les télévisions.", 161, 1000000, 60, 82);
