...
public class ChoosePoke extends JDialog {
	...
	public ChoosePoke() {
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(Initializer.listePoke[comboBox.getSelectedIndex()] == null){
					...
					JOptionPane.showMessageDialog(null, "Le Pok̩mon choisi est incorrect", "Choisissez un Pok̩mon", JOptionPane.ERROR_MESSAGE);
				}else{
		...
		JLabel lblChoisissezUnPokmon = new JLabel("Choisissez un Pok̩mon");
