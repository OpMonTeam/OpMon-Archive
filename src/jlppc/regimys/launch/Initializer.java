...
//		 listePoke[95] = 
		 ...
		 listePoke[120] = new Espece(45, 55, 70, 55, 85, 30, "Stari", Type.EAU, Type.AUCUN, Espece.EVOLTION_BY_TRADE, -1, new E_TradeItem(0, Item.getItem("Pierre Eau")), null, null, new Stats[]{Stats.VIT}, 0.8f, 34.5f, "Même si son corps est détruit, il peut se régénérer aussi longtemps que son cœur est en bon état.", 106, 1250000, 225);
		 listePoke[121] = new Espece(75, 85, 100, 85, 115, "Staross", Type.EAU, Type.AUCUN, Espece.NO_EVOLUTION, -1, new E_Nope (), null, null, new Stats[]{Stats.VIT, Stats.VIT}, 1.1f, 80f, "Son cœur brille des couleurs de l'arc-en-ciel. On raconte que c'est une pierre précieuse.", 207, 1250000, 60);                                                                                                                   
