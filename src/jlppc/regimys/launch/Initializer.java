...
public class Initializer {
	 ...
	 */
	 public static void initPokemons(){
		 ...
		 listePoke[84] = new Espece(85, 45, 35, 35, 75, 35, "Doduo", Type.NORMAL, Type.VOL, Espece.EVOLTUTION_BY_LEVEL, 31, new E_Level(31, 85), null, null, new Stats[]{Stats.ATK}, 1.4f, 39.2f, "Ses deux cerveaux semblent communiquer leurs émotions grâce à un lien télépathique.", 96, 1000000, 190);                                                                        
		 listePoke[85] = new Espece(110, 70, 60, 60, 110, 60, "Dodrio", Type.NORMAL, Type.VOL, Espece.NO_EVOLUTION, -1, ne, null, null, new Stats[]{Stats.ATK, Stats.ATK}, 1.8f, 85.2f, "Un ennemi ne faisant pas attention à l'une des trois têtes pendant une seconde se fait picorer.", 158, 1000000, 45);
		 listePoke[86] = new Espece(45, 55, 45, 70, 45, 65, "Otaria", Type.EAU, Type.AUCUN, Espece.EVOLUTION_BY_LEVEL, 34, new E_Level(34, 87), null, null, new Stats[]{Stats.DEFSPE}, 1.1f, 90f, "Un habitant des icebergs. En mer, il utilise la corne sur sa tête pour briser la banquise.", 100, 1000000, 190);
		 listePoke[87] = new Espece(70, 80, 70, 95, 70, 90, "Lamantine", Type.EAU, Type.GLACE, Espece.NO_EVOLUTION, -1, ne, null, null, new Stats[]{Stats.DEFSPE, Stats.DEFSPE}, 1.7f, 120f, "Son corps hydrodynamique glisse dans l'eau. Plus l'eau est froide plus il se sent à l'aise.", 176, 1000000, 75);
		 listePoke[88] = new Espece(80, 50, 40, 50, 25, 80, "Tadmorv", Type.POISON, Type.AUCUN, Espece.EVOLUTION_BY_LEVEL, 38, new E_Level(38, 89), null, null, new Stats[]{Stats.PV}, 0.9f, 30f, "Vivant dans des tas d'ordures, il se nourrit des déchets polluants rejetés par les usines.", 90, 1000000, 190);
		 listePoke[89] = new Espece(105, 75, 65, 100, 50, 105, "Grotadmorv", Type.POISON, Type.AUCUN, Espece.NO_EVOLUTION, -1, ne, null, null, new Stats[]{Stats.PV, Stats.ATK}, 1.2f, 30f, "Son corps exsude un fluide toxique qui tue instantanément les plantes et les arbres au contact.", 157, 1000000, 75);
		 ...
		 listePoke[93] = new Espece(50, 45, 115, 55, 95, 45, "Spectrum", Type.SPECTRE, Type.POISON, Espece.EVOLUTION_BY_TRADE, -1, new E_Trade(94), null, null, new Stats[]{Stats.ATK, Stats.ATK}, 1.6f, 0.2f, "Il vole l'énergie vitale de l'ennemi d'un coup de langue gazeuse. Il aime chasser dans l'ombre.", 126, 1059860, 90);
		 listePoke[94] = new Espece(65, 60, 130, 75, 110, 60, "Ectoplasma", Type.SPECTRE, Type.POISON, Espece.NO_EVOLUTION, -1, ne, null, null, new Stats[]{Stats.ATKSPE, Stats.ATKSPE, Stats.ATKSPE}, 1.5f, 40.5f, "Si vous frissonnez soudainement, c'est qu'un Ectoplasma en veut à votre vie. Vous ne pouvez y échapper. Abandonnez toute espérance.", 190, 1059860, 45);
 		 listePoke[95] = new Espece(45, 160, 30, 45, 70, 35, "Onix", Type.ROCHE, Type.SOL, Espece.EVOLUTION_BY_TRADE, -1, ne, null, null, new Stats[]{Stats.DEF}, 8.8f, 210f, "Onix vit généralement sous terre. Il cherche de la nourriture en creusant à plus de 80km/h.", 108, 1000000, 45);
		 ...
		 listePoke[114] = new Espece(55, 115, 100, 40, 60, 65, "Saquedeneu", Type.PLANTE, Type.AUCUN, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null, new Stats[]{Stats.DEF}, 1f, 35f, "Il paralyse tout ce qui bouge avec ses lianes. Elles vous chatouillent si vous êtes capturé.", 166, 1000000, 45);
		 listePoke[115] = new Espece(95, 80, 40, 80, 90, 105, "Kangourex", Type.NORMAL, Type.AUCUN, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null, new Stats[]{Stats.PV, Stats.PV}, 2.2f, 80f, "Il élève ses petits dans sa poche ventrale. Il attend d'être en lieu sûr pour les laisser jouer dehors.", 175, 1000000, 45);
		 listePoke[116] = new Espece(40, 70, 70, 25, 60, 30, "Hypotrempe", Type.EAU, Type.AUCUN, Espece.EVOLUTION_BY_LEVEL, 32, new E_Level(117, 32), null, null, new Stats[]{Stats.ATKSPE}, 0.4f, 8f, "Il abat les insectes volants en leur tirant un jet d'encre depuis la surface de l'eau. Ses tirs sont toujours précis.", 83, 1059860, 255);
         	 listePoke[117] = new Espece(65, 95, 95, 45, 85, 55, "Hypocéan", Type.EAU, Type.AUCUN, Espece.NO_EVOLUTION, -1, new E.Nope(), null, null, new Stats[]{Stats.DEF, Stats.ATKSPE}, 1.2f, 25f, "Il peut nager à l'envers en agitant ses petites nageoires pectorales.", 155, 1000000, 75);
		 listePoke[118] = new Espece(67, 60, 35; 50, 63, 45, "Poissirène", Type.EAU, Type.AUCUN, Espece.EVOLUTION_BY_LEVEL, 33, new E_Level(119, 33), null, null, new Stats[]{Stats.ATK}, 0.6f, 15f, "Ses nageoires dorsales et pectorales bougent avec élégance. Il est surnommé le danseur des flots", 111, 1000000, 225);                                                   
		 listePoke[119] = new Espece(92, 65, 65, 80, 68, 80, "Poissoroy", Type.EAU, Type.AUCUN, Espece.NO_EVOLTUTION, -1, new E_Nope(), null, null, new Stats[]{Stats.ATK, Stats.ATK}, 1.3f, 39f, "Il niche dans les rochers du ruisseau qu'il évide avec sa corne. Il donnerait sa vie pour ses Œufs.", 170, 1000000, 60);                                                      
		 listePoke[120] = new Espece(45, 55, 70, 55, 85, 30, "Stari", Type.EAU, Type.AUCUN, Espece.EVOLTION_BY_TRADE, -1, new E_Item(121, Item.getItem("Pierre Eau")), null, null, new Stats[]{Stats.VIT}, 0.8f, 34.5f, "Même si son corps est détruit, il peut se régénérer aussi longtemps que son cœur est en bon état.", 106, 1250000, 225);
		 listePoke[121] = new Espece(75, 85, 100, 85, 115, 60, "Staross", Type.EAU, Type.AUCUN, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null, new Stats[]{Stats.VIT, Stats.VIT}, 1.1f, 80f, "Son cœur brille des couleurs de l'arc-en-ciel. On raconte que c'est une pierre précieuse.", 207, 1250000, 60);                                                                                                                   
		 listePoke[122] = new Espece(45, 65, 100, 120, 90, 40, "M.Mime", Type.PSY, Type.FEE, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null, new Stats[]{Stats.DEFSPE, Stats.DEFSPE}, 1.3f, 54.5f, "Il adore imiter les gens. On le dit capable de créer de véritables murs pour les migrants juste en les mimant.", 136, 10000000, 45);                                                             
		 listePoke[123] = new Espece(110, 80, 55, 80, 105, 70, "Insecateur", Type.INSECTE, Type.VOL, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null, new Stats[]{Stats.ATK}, 1.5f, 56f, "Il fauche les herbes avec ses lames acérées. Il bouge si vite qu'on ne peut le voir à l'œil nu.", 187, 1000000, 45);//TODO evolution a completer                               
		 listePoke[124] = new Espece(50, 35, 115, 95, 95, 65, "Lippoutou", Type.GLACE, Type.PSY, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null, new Stats[]{Stats.ATKSPE, Stats.ATKSPE}, 1.4f, 40.6f, "Elle communique en utilisant un langage qui semble être humain. Des recherches sont en cours pour déterminer ce qu'elle dit.", 137, 1000000, 45);                                                                                                                
		 listePoke[125] = new Espece(83, 87, 95, 85, 105, 65, "Elektek", Type.ELECTRIQUE, Type.AUCUN, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null, new Stats[]{Stats.VIT, Stats;VIT}, 1.1f, 30f, "Il adore se nourrir d'électricité. Il apparaît occasionnellement près des grandes centrales électriques.", 156, 1000000, 45);                                                                                                                                             
		 listePoke[126] = new Espece(95, 57, 100, 85, 93, 65, "Magmar", Type.FEU, Type.AUCUN, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null, new Stats[]{Stats.ATKSPE, Stats.ATKSPE}, 1.3f, 44.5f, "On trouve ce Pokémon près des bouches de volcans. Son corps incandescent atteint 1 200 °C.", 127, 1000000, 45);                                                                                                                
		...
		return false;
	         ...
	         listePoke[135] = new Espece(65, 60, 110, 95, 130, 65, "Voltali", Type.ELECTRIQUE, Type.AUCUN, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null, new Stats[]{Stats.VIT, Stats.VIT}, 0.8f, 24.5f, "Chaque poil sur son corps se dresse quand il se charge en électricité.", 197, 1000000, 45);
	         listePoke[136] = new Espece(130, 60, 95, 110, 65, 65, "Pyroli", Type.FEU, Type.AUCUN, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null, new Stats[]{Stats.ATK, Stats.ATK}, 0.9f, 25.9f, "Son corps contient une glande enflammée. Sa température monte à 900°C avant le combat.", 198, 1000000, 45);
		 ...
		 listePoke[150] = new Espece(110, 90, 154, 90, 130, 106, "Mewtwo", Type.PSY, Type.AUCUN, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null new Stats[]{Stats.ATKSPE, Stats.ATKSPE, Stats.ATKSPE}, 2f, 122f, "Il est le fruit de nombreuses expériences génétiques horribles et malsaines.", 220, 1250000, 3);                                                                                             
	         listePoke[151] = new Espece(100, 100, 100, 100, 100, 100, "Mew",  Type.PSY, Type.AUCUN, Espece.NO_EVOLUTION, -1, new E_Nope(), null, null new Stats[]{Stats.PV, Stats.PV, Stats.PV}, 0.4f, 4f, "Nombre de scientifiques voient en lui l'ancêtre des Pokémon car il maîtrise toutes leurs capacités.", 64, 1059860, 45);
