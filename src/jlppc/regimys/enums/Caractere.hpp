...
namespace Caractere {
    const CaractereClass ASSURE = CaractereClass(Stats::DEF, Stats::ATK, 0),
                         BIZARRE = CaractereClass(Stats::NOTHING, Stats::NOTHING, 1),
                         BRAVE = CaractereClass(Stats::ATK, Stats::SPE, 2),
                         CALME = CaractereClass(Stats::DEFSPE, Stats::ATK, 3),
                         DISCRET = CaractereClass(Stats::ATKSPE, Stats::SPE, 4),
                         DOCILE = CaractereClass(Stats::NOTHING, Stats::NOTHING, 5),
                         ...
                         HARDI = CaractereClass(Stats::NOTHING, Stats::NOTHING, 9),
                         JOVIAL = CaractereClass(Stats::SPE, Stats::ATKSPE, 10),
                         LACHE = CaractereClass(Stats::DEF, Stats::DEFSPE, 11),
                         MALIN = CaractereClass(Stats::DEF, Stats::ATKSPE, 12),
                         MALPOLI = CaractereClass(Stats::DEFSPE, Stats::SPE, 13),
                         MAUVAIS = CaractereClass(Stats::ATK, Stats::DEFSPE, 14),
                         MODESTE = CaractereClass(Stats::ATKSPE, Stats::ATK, 15),
                         NAIF = CaractereClass(Stats::SPE, Stats::DEFSPE, 16),
                         PRESSE = CaractereClass(Stats::SPE, Stats::DEF, 17),
                         PRUDENT = CaractereClass(Stats::DEFSPE, Stats::ATKSPE, 18),
                         PUDIQUE = CaractereClass(Stats::NOTHING, Stats::NOTHING, 19),
                         RELAX = CaractereClass(Stats::DEF, Stats::SPE, 20),
                         RIGIDE = CaractereClass(Stats::ATK, Stats::ATKSPE, 21),
                         SERIEUX = CaractereClass(Stats::NOTHING, Stats::NOTHING, 22),
                         SOLO = CaractereClass(Stats::ATK, Stats::DEF, 23),
                         TIMIDE = CaractereClass(Stats::SPE, Stats::ATK, 24);
