...
class Attaque {
    public:
        virtual ~Attaque() {}
        Attaque(std::string name, int puissance, int type, int precision, bool special, bool status, int chanceDeCoups, bool rateJamais, int ppMax, int priorite, std::string className);
        //->PureVirtual
    ...
    protected:
        ...
        int pp;
        int ppMax;
        /**La chance de coups critiques, en 1/namebre (Par défaut, 16)*/
        int chanceDeCoups;
        bool rateJamais;
