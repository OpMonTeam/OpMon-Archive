...
namespace Attaques {
	...
	public:
		...
		static Class<Abime> *classe = new Class<Abime>("Abime", 0xFFFF);
	};
	...
	class Acidarmure : public Attaque{
		...
		static Class<Acidarmure> *classe = new Class<Acidarmure>("Acidarmure", 0xFFFE);
	};
	...
	class Acide : public Attaque{
		...
		int effetAvant(Pokemon &atk, Pokemon &def){return 0;}
		int effetApres(Pokemon &atk, Pokemon &def);
		static Class<Acide> *classe = new Class<Acide>("Acide", 0xFFFD);
	};
	...
	class Affutage : public Attaque{
		...
		int effetAvant(Pokemon &atk, Pokemon &def){return 0;}
		int effetApres(Pokemon &atk, Pokemon &def);
		static Class<Affutage> *classe = new Class<Affutage>("Affutage", 0xFFFC);
	};
	...
	class Aiguisage : public Attaque{
		...
		int effetAvant(Pokemon &atk, Pokemon &def){return 0;}
		int effetApres(Pokemon &atk, Pokemon &def);
		static Class<Aiguisage> *classe = new Class<Aiguisage>("Aiguisage", 0xFFFB);
	};
	...
	class Amnesie : public Attaque{
		...
		int effetAvant(Pokemon &atk, Pokemon &def){return 0;}
		int effetApres(Pokemon &atk, Pokemon &def);
		static Class<Amnesie> *classe = new Class<Amnesie>("Amnesie", 0xFFFA);
	...
	class Armure : public Attaque{
		...
		int effetAvant(Pokemon &atk, Pokemon &def){return 0;}
		int effetApres(Pokemon &atk, Pokemon &def);
		static Class<Armure> *classe = new Class<Armure>("Armure", 0xFFF9);
	};
	...
	class Belier : public Attaque{
		...
		int effetAvant(Pokemon &atk, Pokemon &def){return 0;}
		int effetApres(Pokemon &atk, Pokemon &def);
		static Class<Belier> *classe = new Class<Belier>("Belier", 0xFFF8);
	};
